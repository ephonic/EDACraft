"""
rtlgen_x.dsl.legacy.codegen — Verilog 代码生成后端

将 rtlgen_x.dsl.legacy.core 构建的 AST 与模块层次遍历输出为可综合的 Verilog-2001 代码。
"""
...
class VerilogEmitter:
    ...
    def emit_with_lint(self, module: Module, auto_fix: bool = False, rules: Optional[List[str]] = None) -> Tuple[str, "LintResult"]:
        ...
        from rtlgen_x.dsl.legacy.lint import VerilogLinter
    ...
    def emit_design(self, top_module: Module, include_assertions: bool = False) -> str:
        ...
        try:
            ...
            if include_assertions:
                from rtlgen_x.dsl.legacy.svagen import SVAEmitter
                sva = SVAEmitter()
                for mod in deduped_order:
    ...
    def _extract_literal_int(expr) -> int | None:
        ...
        from rtlgen_x.dsl.legacy.core import Const
    ...
    def _expr_bit_width(expr) -> int:
        ...
        from rtlgen_x.dsl.legacy.core import Const, Slice, Ref
        if isinstance(expr, Const):
            return expr.width
    ...
    def _collect_arrays_from_ast(self, module: Module, arrays: Dict[str, Any]):
        ...
        from rtlgen_x.dsl.legacy.core import Array, ArrayRead, ArrayWrite
        ...
        def _scan_body(body):
            from rtlgen_x.dsl.legacy.core import SwitchNode
            for stmt in body:
    ...
    def _resolve_cross_module_assignments(self, module: Module):
        ...
        """
        from rtlgen_x.dsl.legacy.core import Assign, Input, Output, Signal, SubmoduleInst
...
def _to_expr(val: Any) -> Expr:
    from rtlgen_x.dsl.legacy.core import Parameter
    if isinstance(val, Signal):
        return val._expr
