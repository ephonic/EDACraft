module js_zk_mul_level2(	//96x96 or similar bits
clk,
rstn,
a,
b,
...
js_zk_mul_level1 #(L_WIDTH, L_WIDTH) u0_mul (
	.clk	(clk),
	.en0	(en0),
	.en1	(en1),
	.a		(a0),
...
js_zk_mul_level1 #(H_WIDTH, H_WIDTH) u1_mul (
	.clk	(clk),
	.en0	(en0),
	.en1	(en1),
	.a		(a1),
...
js_zk_mul_level1 #(F_WIDTH, F_WIDTH) u2_mul (
	.clk	(clk),
	.en0	(en0),
	.en1	(en1),
	.a		(a_fold),
