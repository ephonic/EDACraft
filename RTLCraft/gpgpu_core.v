...
module GPGPUCore (
    ...
    assign wr_en[0] = (((wb_sel == 0) & out_valid) & issue_mask[0]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[1] = (((wb_sel == 0) & out_valid) & issue_mask[1]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[2] = (((wb_sel == 0) & out_valid) & issue_mask[2]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[3] = (((wb_sel == 0) & out_valid) & issue_mask[3]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[4] = (((wb_sel == 0) & out_valid) & issue_mask[4]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[5] = (((wb_sel == 0) & out_valid) & issue_mask[5]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[6] = (((wb_sel == 0) & out_valid) & issue_mask[6]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[7] = (((wb_sel == 0) & out_valid) & issue_mask[7]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[8] = (((wb_sel == 0) & out_valid) & issue_mask[8]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[9] = (((wb_sel == 0) & out_valid) & issue_mask[9]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[10] = (((wb_sel == 0) & out_valid) & issue_mask[10]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[11] = (((wb_sel == 0) & out_valid) & issue_mask[11]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[12] = (((wb_sel == 0) & out_valid) & issue_mask[12]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[13] = (((wb_sel == 0) & out_valid) & issue_mask[13]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[14] = (((wb_sel == 0) & out_valid) & issue_mask[14]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[15] = (((wb_sel == 0) & out_valid) & issue_mask[15]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[16] = (((wb_sel == 0) & out_valid) & issue_mask[16]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[17] = (((wb_sel == 0) & out_valid) & issue_mask[17]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[18] = (((wb_sel == 0) & out_valid) & issue_mask[18]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[19] = (((wb_sel == 0) & out_valid) & issue_mask[19]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[20] = (((wb_sel == 0) & out_valid) & issue_mask[20]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[21] = (((wb_sel == 0) & out_valid) & issue_mask[21]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[22] = (((wb_sel == 0) & out_valid) & issue_mask[22]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[23] = (((wb_sel == 0) & out_valid) & issue_mask[23]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[24] = (((wb_sel == 0) & out_valid) & issue_mask[24]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[25] = (((wb_sel == 0) & out_valid) & issue_mask[25]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[26] = (((wb_sel == 0) & out_valid) & issue_mask[26]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[27] = (((wb_sel == 0) & out_valid) & issue_mask[27]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[28] = (((wb_sel == 0) & out_valid) & issue_mask[28]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[29] = (((wb_sel == 0) & out_valid) & issue_mask[29]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[30] = (((wb_sel == 0) & out_valid) & issue_mask[30]);
    always @(*) begin
        case (wb_sel)
    ...
    assign wr_en[31] = (((wb_sel == 0) & out_valid) & issue_mask[31]);
