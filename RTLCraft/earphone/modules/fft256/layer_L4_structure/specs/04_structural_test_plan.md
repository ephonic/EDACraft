...
|-------------|-------|---------|
| FFT256-L4_STRUCTURE-001 | EarphoneFFT256 L4 structure specification | 0.1 |
...
| DUT Version | 0.1 |
| Hierarchy Path | earphone.modules.fft256.layer_L4_structure |
...
| TC ID | Name | Type | Priority | Objective | Status |
| --- | --- | --- | --- | --- | --- |
| FFT256-L4_STRUCTURE-TC-001 | test_structure_contract_contains_required_subblocks | Directed | P1 | Validate structure contract contains required subblocks. | Planned |
| FFT256-L4_STRUCTURE-TC-002 | test_structure_contract_subblocks_have_interfaces | Directed | P1 | Validate structure contract subblocks have interfaces. | Planned |
...
|-------------|------|-----------|-------|
| local-pytest | pytest | per flow run | EarphoneFFT256 L4 structure |
