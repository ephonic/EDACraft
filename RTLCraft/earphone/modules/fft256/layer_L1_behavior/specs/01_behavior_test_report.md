# EarphoneFFT256 — L1 behavior Test Report — Verification Test Report

| Document ID | FFT256-L1_BEHAVIOR-TR-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
| Author      | RTLCraft Agent |
| Owner       | Design Team |
| Test Plan Reference | FFT256-L1_BEHAVIOR-TP-001 |
| Status      | Draft |
...
|--------|--------|----------|--------|
| Total Test Cases | 3 | 3 | OK |
| Passed | 3 | 3 | OK |
| Failed | 0 | 0 | OK |
| Blocked / Skipped | 0 | 0 | OK |
| Line Coverage | 80% | Not measured | WAIVED |
| Functional Coverage | All directed tests pass | 3/3 passed | OK |
...
### 2.2 Scope Summary
EarphoneFFT256 L1 behavior layer-local pytest execution with upstream feedback on failures or missing coverage.
...
Command: /opt/anaconda3/bin/python -m pytest /Users/yangfan/release/EDACraft-main/RTLCraft/earphone/modules/fft256/layer_L1_behavior/tests -q --tb=short
...
|-------|------|----------|-------|
| TC-PASS | L1 behavior pytest suite | 0.34s | 3 tests passed |
...
| Expression | Directed expression paths | 3/3 tests passed | None | OK |

### 6.2 Functional Coverage
| Covergroup / Point | Target | Achieved | Gap | Status |
|--------------------|--------|----------|-----|--------|
| L1 behavior contract coverage | All directed tests pass | 3/3 | None | OK |
...
|--------|------|-------|------|------|------|----------|--------|
| fft256-L1_behavior-2026-06-18 | 2026-06-18 | 3 | 3 | 0 | 0 | 0.34s | PASS |

---

## 10. Conclusion

Layer L1 behavior tests completed: 3/3 passed in 0.34s.
...
earphone/modules/fft256/layer_L1_behavior/tests/test_behavior.py ...     [100%]

============================== 3 passed in 0.15s ===============================

### Appendix B: Tool Command History
/opt/anaconda3/bin/python -m pytest /Users/yangfan/release/EDACraft-main/RTLCraft/earphone/modules/fft256/layer_L1_behavior/tests -q --tb=short
