# EarphoneFFT256 — L1 behavior — Verification Test Plan

| Document ID | FFT256-L1_BEHAVIOR-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
...
### 1.1 Purpose
Verification test plan for the L1 behavior of EarphoneFFT256.
...
|-------------|-------|---------|
| FFT256-L1_BEHAVIOR-001 | EarphoneFFT256 L1 behavior specification | 0.1 |
...
| DUT Version | 0.1 |
| Hierarchy Path | earphone.modules.fft256.layer_L1_behavior |
...
Run the pytest cases listed in `layer_L1_behavior/specs/01_behavior_test_plan.md` under `earphone/modules/fft256/layer_L1_behavior/tests`, then publish PASS/FAIL evidence in `layer_L1_behavior/specs/01_behavior_test_report.md`. Test intent: Consumes the module contract `FFT256-MOD-001` and top-level SoC requirements as the seed SpecIR.
...
|-------|------|------|----------|-----------|--------|
| TC-001 | test_dc_response | Directed | P1 | Validate dc response. | Planned |
...
| TC ID | Name | Type | Priority | Objective | Status |
| --- | --- | --- | --- | --- | --- |
| FFT256-L1_BEHAVIOR-TC-001 | test_dc_response | Directed | P1 | Validate dc response. | Planned |
| FFT256-L1_BEHAVIOR-TC-002 | test_describe | Directed | P1 | Validate describe. | Planned |
| FFT256-L1_BEHAVIOR-TC-003 | test_impulse_response | Directed | P1 | Validate impulse response. | Planned |

### 7.2 Detailed Test Cases

#### TC-001: test_dc_response
| Attribute | Description |
|-----------|-------------|
| Objective | Validate dc response. |
...
|-------------|------|-----------|-------|
| local-pytest | pytest | per flow run | EarphoneFFT256 L1 behavior |
