# EarphoneFFT256 — L6 verilog Test Report — Verification Test Report

| Document ID | FFT256-L6_VERILOG-TR-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
| Author      | RTLCraft Agent |
| Owner       | Design Team |
| Test Plan Reference | FFT256-L6_VERILOG-TP-001 |
| Status      | Draft |
...
### 2.2 Scope Summary
EarphoneFFT256 L6 verilog layer-local pytest execution with upstream feedback on failures or missing coverage.
...
Command: /opt/anaconda3/bin/python -m pytest /Users/yangfan/release/EDACraft-main/RTLCraft/earphone/modules/fft256/layer_L6_verilog/tests -q --tb=short
...
|-------|------|----------|-------|
| TC-PASS | L6 verilog pytest suite | 0.30s | 2 tests passed |
...
|--------|------|-------|------|------|------|----------|--------|
| fft256-L6_verilog-2026-06-18 | 2026-06-18 | 2 | 2 | 0 | 0 | 0.30s | PASS |

---

## 10. Conclusion

Layer L6 verilog tests completed: 2/2 passed in 0.30s.
...
earphone/modules/fft256/layer_L6_verilog/tests/test_verilog.py ..        [100%]

============================== 2 passed in 0.11s ===============================

### Appendix B: Tool Command History
/opt/anaconda3/bin/python -m pytest /Users/yangfan/release/EDACraft-main/RTLCraft/earphone/modules/fft256/layer_L6_verilog/tests -q --tb=short
