...
Run the layer-specific pytest suite under earphone/modules/fft256/L6_verilog/tests and verify functional equivalence with adjacent layers where applicable.
