# EarphoneFFT256 — L2 cycle — Verification Test Plan

| Document ID | FFT256-L2_CYCLE-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
...
### 1.1 Purpose
Verification test plan for the L2 cycle of EarphoneFFT256.
...
|-------------|-------|---------|
| FFT256-L2_CYCLE-001 | EarphoneFFT256 L2 cycle specification | 0.1 |
...
| DUT Version | 0.1 |
| Hierarchy Path | earphone.modules.fft256.layer_L2_cycle |
...
Run the pytest cases listed in `layer_L2_cycle/specs/02_cycle_test_plan.md` under `earphone/modules/fft256/layer_L2_cycle/tests`, then publish PASS/FAIL evidence in `layer_L2_cycle/specs/02_cycle_test_report.md`. Test intent: Consumes approved outputs from `FFT256-L1_BEHAVIOR-001` (`layer_L1_behavior/specs/01_behavior_spec.md`), plus verification intent `FFT256-L1_BEHAVIOR-TP-001` (`layer_L1_behavior/specs/01_behavior_test_plan.md`) and latest evidence `FFT256-L1_BEHAVIOR-TR-001` (`layer_L1_behavior/specs/01_behavior_test_report.md`).
...
|-------------|------|-----------|-------|
| local-pytest | pytest | per flow run | EarphoneFFT256 L2 cycle |
