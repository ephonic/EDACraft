# EarphoneFFT256 — L5 dsl Test Report — Verification Test Report

| Document ID | FFT256-L5_DSL-TR-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
| Author      | RTLCraft Agent |
| Owner       | Design Team |
| Test Plan Reference | FFT256-L5_DSL-TP-001 |
| Status      | Draft |
...
### 2.2 Scope Summary
EarphoneFFT256 L5 dsl layer-local pytest execution with upstream feedback on failures or missing coverage.
...
Command: /opt/anaconda3/bin/python -m pytest /Users/yangfan/release/EDACraft-main/RTLCraft/earphone/modules/fft256/layer_L5_dsl/tests -q --tb=short
...
|-------|------|----------|-------|
| TC-PASS | L5 dsl pytest suite | 0.33s | 3 tests passed |
...
|--------|------|-------|------|------|------|----------|--------|
| fft256-L5_dsl-2026-06-18 | 2026-06-18 | 3 | 3 | 0 | 0 | 0.33s | PASS |

---

## 10. Conclusion

Layer L5 dsl tests completed: 3/3 passed in 0.33s.
...
earphone/modules/fft256/layer_L5_dsl/tests/test_dsl.py ...               [100%]

============================== 3 passed in 0.15s ===============================

### Appendix B: Tool Command History
/opt/anaconda3/bin/python -m pytest /Users/yangfan/release/EDACraft-main/RTLCraft/earphone/modules/fft256/layer_L5_dsl/tests -q --tb=short
