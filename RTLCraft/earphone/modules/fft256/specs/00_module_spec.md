# EarphoneFFT256 — Module Design Specification
...
### 1.3 Use Cases
Used inside the Smart Earphone SoC as the EarphoneFFT256 block.

### 1.4 Block Diagram

See layer_L4_structure/specs/04_structural_spec.md for the internal decomposition of EarphoneFFT256.
...
EarphoneFFT256 operation is described per-IR-layer in the layer_L*/specs/ documents.

### 6.2 State Machine(s)

| State | Encoding | Description | Exit Conditions |
|-------|----------|-------------|-----------------|
| Operational | implementation-defined | Normal active state for EarphoneFFT256. | Reset, stall, or module-specific completion. |
...
|----|-------------|--------|-------|
| D-01 | fft256 layer contracts, source, tests, reports, and generated RTL where applicable | Markdown, JSON, Python, Verilog | RTLCraft Agent |
