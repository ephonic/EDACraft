# EarphoneFFT256 — Module Test Report — Verification Test Report

| Document ID | FFT256-MOD-TR-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
| Author      | RTLCraft Agent |
| Owner       | Design Team |
| Test Plan Reference | FFT256-MOD-TP-001 |
| Status      | Draft |
...
|-------|-------|--------|--------|---------|----------|
| module_aggregate | 13 | 13 | 0 | 0 | N/A |
...
| Suite | Total | Passed | Failed | Skipped | Coverage |
| --- | --- | --- | --- | --- | --- |
| L1_behavior | 3 | 3 | 0 | 0 | N/A |
| L2_cycle | 1 | 1 | 0 | 0 | N/A |
...
|-------|------|----------|-------|
| MOD-PASS | module layered regression | 1.46s | 13 layer tests passed across 6 layers |
...
| Expression | No layer suite regressions | 13/13 passed | None | OK |
...
|--------|------|-------|------|------|------|----------|--------|
| fft256-module-2026-06-18 | 2026-06-18 | 13 | 13 | 0 | 0 | 1.46s | PASS |

---

## 10. Conclusion

Module aggregate completed with 13/13 passing tests across 6 layers.
