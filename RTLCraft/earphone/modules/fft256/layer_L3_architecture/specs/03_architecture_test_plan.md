# EarphoneFFT256 — L3 architecture — Verification Test Plan

| Document ID | FFT256-L3_ARCHITECTURE-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
...
### 1.1 Purpose
Verification test plan for the L3 architecture of EarphoneFFT256.
...
|-------------|-------|---------|
| FFT256-L3_ARCHITECTURE-001 | EarphoneFFT256 L3 architecture specification | 0.1 |
...
| DUT Version | 0.1 |
| Hierarchy Path | earphone.modules.fft256.layer_L3_architecture |
...
| TC ID | Name | Type | Priority | Objective | Status |
| --- | --- | --- | --- | --- | --- |
| FFT256-L3_ARCHITECTURE-TC-001 | test_architecture_contract_contains_required_pipeline_and_invariants | Directed | P1 | Validate architecture contract contains required pipeline and invariants. | Planned |
| FFT256-L3_ARCHITECTURE-TC-002 | test_architecture_contract_names_core_shape | Directed | P1 | Validate architecture contract names core shape. | Planned |
...
|-------------|------|-----------|-------|
| local-pytest | pytest | per flow run | EarphoneFFT256 L3 architecture |
