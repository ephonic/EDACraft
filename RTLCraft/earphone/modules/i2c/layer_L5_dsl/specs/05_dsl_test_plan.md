# EarphoneI2C — L5 dsl — Verification Test Plan

| Document ID | I2C-L5_DSL-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
...
### 1.1 Purpose
Verification test plan for the L5 dsl of EarphoneI2C.
...
|-------------|-------|---------|
| I2C-L5_DSL-001 | EarphoneI2C L5 dsl specification | 0.1 |
...
| DUT Version | 0.1 |
| Hierarchy Path | earphone.modules.i2c.layer_L5_dsl |
...
Run the pytest cases listed in `layer_L5_dsl/specs/05_dsl_test_plan.md` under `earphone/modules/i2c/layer_L5_dsl/tests`, then publish PASS/FAIL evidence in `layer_L5_dsl/specs/05_dsl_test_report.md`. Test intent: Consumes approved outputs from `I2C-L4_STRUCTURE-001` (`layer_L4_structure/specs/04_structural_spec.md`), plus verification intent `I2C-L4_STRUCTURE-TP-001` (`layer_L4_structure/specs/04_structural_test_plan.md`) and latest evidence `I2C-L4_STRUCTURE-TR-001` (`layer_L4_structure/specs/04_structural_test_report.md`).
...
|-------|------|------|----------|-----------|--------|
| TC-001 | test_apb_readback | Directed | P1 | Validate apb readback. | Planned |
...
| TC ID | Name | Type | Priority | Objective | Status |
| --- | --- | --- | --- | --- | --- |
| I2C-L5_DSL-TC-001 | test_apb_readback | Directed | P1 | Validate apb readback. | Planned |
| I2C-L5_DSL-TC-002 | test_read_transaction_completes | Directed | P1 | Read path reaches DONE; the current FSM does not terminate writes. | Planned |

### 7.2 Detailed Test Cases

#### TC-001: test_apb_readback
| Attribute | Description |
|-----------|-------------|
| Objective | Validate apb readback. |
...
|-------------|------|-----------|-------|
| local-pytest | pytest | per flow run | EarphoneI2C L5 dsl |
