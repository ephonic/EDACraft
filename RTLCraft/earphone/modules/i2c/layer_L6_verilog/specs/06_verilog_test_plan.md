...
Run the layer-specific pytest suite under earphone/modules/i2c/L6_verilog/tests and verify functional equivalence with adjacent layers where applicable.
