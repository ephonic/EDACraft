...
Run the layer-specific pytest suite under earphone/modules/i2c/L3_architecture/tests and verify functional equivalence with adjacent layers where applicable.
