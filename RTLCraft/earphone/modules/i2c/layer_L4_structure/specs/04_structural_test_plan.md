...
Run the layer-specific pytest suite under earphone/modules/i2c/L4_structure/tests and verify functional equivalence with adjacent layers where applicable.
