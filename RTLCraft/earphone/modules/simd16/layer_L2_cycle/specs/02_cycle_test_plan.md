# EarphoneSIMD16 — L2 cycle — Verification Test Plan

| Document ID | SIMD16-L2_CYCLE-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
...
### 1.1 Purpose
Verification test plan for the L2 cycle of EarphoneSIMD16.
...
|-------------|-------|---------|
| SIMD16-L2_CYCLE-001 | EarphoneSIMD16 L2 cycle specification | 0.1 |
...
| DUT Version | 0.1 |
| Hierarchy Path | earphone.modules.simd16.layer_L2_cycle |
...
Run the pytest cases listed in `layer_L2_cycle/specs/02_cycle_test_plan.md` under `earphone/modules/simd16/layer_L2_cycle/tests`, then publish PASS/FAIL evidence in `layer_L2_cycle/specs/02_cycle_test_report.md`. Test intent: Consumes approved outputs from `SIMD16-L1_BEHAVIOR-001` (`layer_L1_behavior/specs/01_behavior_spec.md`), plus verification intent `SIMD16-L1_BEHAVIOR-TP-001` (`layer_L1_behavior/specs/01_behavior_test_plan.md`) and latest evidence `SIMD16-L1_BEHAVIOR-TR-001` (`layer_L1_behavior/specs/01_behavior_test_report.md`).
...
| TC ID | Name | Type | Priority | Objective | Status |
| --- | --- | --- | --- | --- | --- |
| SIMD16-L2_CYCLE-TC-001 | test_describe | Directed | P1 | Validate describe. | Planned |
| SIMD16-L2_CYCLE-TC-002 | test_fp16_mac_three_cycle_latency | Directed | P1 | Validate fp16 mac three cycle latency. | Planned |
| SIMD16-L2_CYCLE-TC-003 | test_int16_single_cycle_latency | Directed | P1 | Validate int16 single cycle latency. | Planned |
...
|-------------|------|-----------|-------|
| local-pytest | pytest | per flow run | EarphoneSIMD16 L2 cycle |
