...
Run the layer-specific pytest suite under earphone/modules/simd16/L2_cycle/tests and verify functional equivalence with adjacent layers where applicable.
