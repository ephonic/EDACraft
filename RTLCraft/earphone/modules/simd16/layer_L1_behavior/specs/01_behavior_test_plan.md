# EarphoneSIMD16 — L1 behavior — Verification Test Plan

| Document ID | SIMD16-L1_BEHAVIOR-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
...
### 1.1 Purpose
Verification test plan for the L1 behavior of EarphoneSIMD16.
...
|-------------|-------|---------|
| SIMD16-L1_BEHAVIOR-001 | EarphoneSIMD16 L1 behavior specification | 0.1 |
...
| DUT Version | 0.1 |
| Hierarchy Path | earphone.modules.simd16.layer_L1_behavior |
...
Run the pytest cases listed in `layer_L1_behavior/specs/01_behavior_test_plan.md` under `earphone/modules/simd16/layer_L1_behavior/tests`, then publish PASS/FAIL evidence in `layer_L1_behavior/specs/01_behavior_test_report.md`. Test intent: Consumes the module contract `SIMD16-MOD-001` and top-level SoC requirements as the seed SpecIR.
...
|-------|------|------|----------|-----------|--------|
| TC-001 | test_fp16_mac_lane | Directed | P1 | Validate fp16 mac lane. | Planned |
...
| TC ID | Name | Type | Priority | Objective | Status |
| --- | --- | --- | --- | --- | --- |
| SIMD16-L1_BEHAVIOR-TC-001 | test_fp16_mac_lane | Directed | P1 | Validate fp16 mac lane. | Planned |
| SIMD16-L1_BEHAVIOR-TC-002 | test_predicate_mask | Directed | P1 | Validate predicate mask. | Planned |
| SIMD16-L1_BEHAVIOR-TC-003 | test_vadd_lanes | Directed | P1 | Validate vadd lanes. | Planned |
| SIMD16-L1_BEHAVIOR-TC-004 | test_vand_lanes | Directed | P1 | Validate vand lanes. | Planned |
| SIMD16-L1_BEHAVIOR-TC-005 | test_vcmp_eq_lanes | Directed | P1 | Validate vcmp eq lanes. | Planned |
| SIMD16-L1_BEHAVIOR-TC-006 | test_vsub_lanes | Directed | P1 | Validate vsub lanes. | Planned |

### 7.2 Detailed Test Cases

#### TC-001: test_fp16_mac_lane
| Attribute | Description |
|-----------|-------------|
| Objective | Validate fp16 mac lane. |
...
|-------------|------|-----------|-------|
| local-pytest | pytest | per flow run | EarphoneSIMD16 L1 behavior |
