...
Run the layer-specific pytest suite under earphone/modules/simd16/L6_verilog/tests and verify functional equivalence with adjacent layers where applicable.
