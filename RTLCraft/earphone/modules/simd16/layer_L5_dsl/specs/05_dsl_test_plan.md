# EarphoneSIMD16 — L5 dsl — Verification Test Plan

| Document ID | SIMD16-L5_DSL-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
...
### 1.1 Purpose
Verification test plan for the L5 dsl of EarphoneSIMD16.
...
|-------------|-------|---------|
| SIMD16-L5_DSL-001 | EarphoneSIMD16 L5 dsl specification | 0.1 |
...
| DUT Version | 0.1 |
| Hierarchy Path | earphone.modules.simd16.layer_L5_dsl |
...
Run the pytest cases listed in `layer_L5_dsl/specs/05_dsl_test_plan.md` under `earphone/modules/simd16/layer_L5_dsl/tests`, then publish PASS/FAIL evidence in `layer_L5_dsl/specs/05_dsl_test_report.md`. Test intent: Consumes approved outputs from `SIMD16-L4_STRUCTURE-001` (`layer_L4_structure/specs/04_structural_spec.md`), plus verification intent `SIMD16-L4_STRUCTURE-TP-001` (`layer_L4_structure/specs/04_structural_test_plan.md`) and latest evidence `SIMD16-L4_STRUCTURE-TR-001` (`layer_L4_structure/specs/04_structural_test_report.md`).
...
|-------|------|------|----------|-----------|--------|
| TC-001 | test_fp16_mac_three_cycle_latency | Directed | P1 | Validate fp16 mac three cycle latency. | Planned |
...
| TC ID | Name | Type | Priority | Objective | Status |
| --- | --- | --- | --- | --- | --- |
| SIMD16-L5_DSL-TC-001 | test_fp16_mac_three_cycle_latency | Directed | P1 | Validate fp16 mac three cycle latency. | Planned |
| SIMD16-L5_DSL-TC-002 | test_int16_vadd_one_cycle | Directed | P1 | Validate int16 vadd one cycle. | Planned |

### 7.2 Detailed Test Cases

#### TC-001: test_fp16_mac_three_cycle_latency
| Attribute | Description |
|-----------|-------------|
| Objective | Validate fp16 mac three cycle latency. |
...
|-------------|------|-----------|-------|
| local-pytest | pytest | per flow run | EarphoneSIMD16 L5 dsl |
