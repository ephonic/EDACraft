...
Run the layer-specific pytest suite under earphone/modules/simd16/L5_dsl/tests and verify functional equivalence with adjacent layers where applicable.
