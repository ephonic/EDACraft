...
Run the layer-specific pytest suite under earphone/modules/apb_bridge/L3_architecture/tests and verify functional equivalence with adjacent layers where applicable.
