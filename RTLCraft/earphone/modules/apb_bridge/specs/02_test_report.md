# EarphoneAPBBridge — Module Test Report — Verification Test Report

| Document ID | APB_BRIDGE-MOD-TR-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
| Author      | RTLCraft Agent |
| Owner       | Design Team |
| Test Plan Reference | APB_BRIDGE-MOD-TP-001 |
| Status      | Draft |
...
|-------|------|----------|-------|
| MOD-PASS | module layered regression | 1.26s | 16 layer tests passed across 6 layers |
...
|--------|------|-------|------|------|------|----------|--------|
| apb_bridge-module-2026-06-18 | 2026-06-18 | 16 | 16 | 0 | 0 | 1.26s | PASS |
