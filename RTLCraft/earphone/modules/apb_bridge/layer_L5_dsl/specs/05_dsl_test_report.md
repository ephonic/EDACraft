# EarphoneAPBBridge — L5 dsl Test Report — Verification Test Report

| Document ID | APB_BRIDGE-L5_DSL-TR-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
| Author      | RTLCraft Agent |
| Owner       | Design Team |
| Test Plan Reference | APB_BRIDGE-L5_DSL-TP-001 |
| Status      | Draft |
...
### 2.2 Scope Summary
EarphoneAPBBridge L5 dsl layer-local pytest execution with upstream feedback on failures or missing coverage.
...
Command: /opt/anaconda3/bin/python -m pytest /Users/yangfan/release/EDACraft-main/RTLCraft/earphone/modules/apb_bridge/layer_L5_dsl/tests -q --tb=short
...
|-------|------|----------|-------|
| TC-PASS | L5 dsl pytest suite | 0.26s | 5 tests passed |
...
|--------------------|--------|----------|-----|--------|
| L5 dsl contract coverage | All directed tests pass | 5/5 | None | OK |
...
|--------|------|-------|------|------|------|----------|--------|
| apb_bridge-L5_dsl-2026-06-18 | 2026-06-18 | 5 | 5 | 0 | 0 | 0.26s | PASS |

---

## 10. Conclusion

Layer L5 dsl tests completed: 5/5 passed in 0.26s.
...
earphone/modules/apb_bridge/layer_L5_dsl/tests/test_dsl.py .....         [100%]

============================== 5 passed in 0.08s ===============================

### Appendix B: Tool Command History
/opt/anaconda3/bin/python -m pytest /Users/yangfan/release/EDACraft-main/RTLCraft/earphone/modules/apb_bridge/layer_L5_dsl/tests -q --tb=short
