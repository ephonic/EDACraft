# EarphoneAPBBridge — L5 dsl — Verification Test Plan

| Document ID | APB_BRIDGE-L5_DSL-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
...
### 1.1 Purpose
Verification test plan for the L5 dsl of EarphoneAPBBridge.
...
|-------------|-------|---------|
| APB_BRIDGE-L5_DSL-001 | EarphoneAPBBridge L5 dsl specification | 0.1 |
...
| DUT Version | 0.1 |
| Hierarchy Path | earphone.modules.apb_bridge.layer_L5_dsl |
...
Run the pytest cases listed in `layer_L5_dsl/specs/05_dsl_test_plan.md` under `earphone/modules/apb_bridge/layer_L5_dsl/tests`, then publish PASS/FAIL evidence in `layer_L5_dsl/specs/05_dsl_test_report.md`. Test intent: Consumes approved outputs from `APB_BRIDGE-L4_STRUCTURE-001` (`layer_L4_structure/specs/04_structural_spec.md`), plus verification intent `APB_BRIDGE-L4_STRUCTURE-TP-001` (`layer_L4_structure/specs/04_structural_test_plan.md`) and latest evidence `APB_BRIDGE-L4_STRUCTURE-TR-001` (`layer_L4_structure/specs/04_structural_test_report.md`).
...
|-------|------|------|----------|-----------|--------|
| TC-001 | test_decode_qspi_region | Directed | P1 | Validate decode qspi region. | Planned |
...
| TC ID | Name | Type | Priority | Objective | Status |
| --- | --- | --- | --- | --- | --- |
| APB_BRIDGE-L5_DSL-TC-001 | test_decode_qspi_region | Directed | P1 | Validate decode qspi region. | Planned |
| APB_BRIDGE-L5_DSL-TC-002 | test_decode_simd16_region | Directed | P1 | Validate decode simd16 region. | Planned |
| APB_BRIDGE-L5_DSL-TC-003 | test_decode_sram_region | Directed | P1 | Validate decode sram region. | Planned |
| APB_BRIDGE-L5_DSL-TC-004 | test_slave_response_mux | Directed | P1 | Validate slave response mux. | Planned |
| APB_BRIDGE-L5_DSL-TC-005 | test_unselected_no_pready | Directed | P1 | Validate unselected no pready. | Planned |

### 7.2 Detailed Test Cases

#### TC-001: test_decode_qspi_region
| Attribute | Description |
|-----------|-------------|
| Objective | Validate decode qspi region. |
...
|-------------|------|-----------|-------|
| local-pytest | pytest | per flow run | EarphoneAPBBridge L5 dsl |
