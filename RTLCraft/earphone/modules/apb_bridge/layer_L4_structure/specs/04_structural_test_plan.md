...
Run the layer-specific pytest suite under earphone/modules/apb_bridge/L4_structure/tests and verify functional equivalence with adjacent layers where applicable.
