...
Run the layer-specific pytest suite under earphone/modules/apb_bridge/L6_verilog/tests and verify functional equivalence with adjacent layers where applicable.
