...
Run the layer-specific pytest suite under earphone/modules/qspi/L2_cycle/tests and verify functional equivalence with adjacent layers where applicable.
