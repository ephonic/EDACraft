# EarphoneQSPI — Module Design Specification

| Document ID | QSPI-MOD-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
...
### 1.1 Purpose
Quad-SPI XIP controller for 32 MB external Flash (cmd/addr/data FSM).
...
### 1.3 Use Cases
Used inside the Smart Earphone SoC as the EarphoneQSPI block.

### 1.4 Block Diagram

See layer_L4_structure/specs/04_structural_spec.md for the internal decomposition of EarphoneQSPI.
...
EarphoneQSPI operation is described per-IR-layer in the layer_L*/specs/ documents.

### 6.2 State Machine(s)

| State | Encoding | Description | Exit Conditions |
|-------|----------|-------------|-----------------|
| Operational | implementation-defined | Normal active state for EarphoneQSPI. | Reset, stall, or module-specific completion. |
...
|----|-------------|--------|-------|
| D-01 | qspi layer contracts, source, tests, reports, and generated RTL where applicable | Markdown, JSON, Python, Verilog | RTLCraft Agent |
