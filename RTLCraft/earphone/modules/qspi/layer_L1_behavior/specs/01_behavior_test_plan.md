...
Run the layer-specific pytest suite under earphone/modules/qspi/L1_behavior/tests and verify functional equivalence with adjacent layers where applicable.
