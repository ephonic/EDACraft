# EarphoneQSPI — L5 dsl — Verification Test Plan

| Document ID | QSPI-L5_DSL-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
...
### 1.1 Purpose
Verification test plan for the L5 dsl of EarphoneQSPI.
...
|-------------|-------|---------|
| QSPI-L5_DSL-001 | EarphoneQSPI L5 dsl specification | 0.1 |
...
| DUT Version | 0.1 |
| Hierarchy Path | earphone.modules.qspi.layer_L5_dsl |
...
Run the pytest cases listed in `layer_L5_dsl/specs/05_dsl_test_plan.md` under `earphone/modules/qspi/layer_L5_dsl/tests`, then publish PASS/FAIL evidence in `layer_L5_dsl/specs/05_dsl_test_report.md`. Test intent: Consumes approved outputs from `QSPI-L4_STRUCTURE-001` (`layer_L4_structure/specs/04_structural_spec.md`), plus verification intent `QSPI-L4_STRUCTURE-TP-001` (`layer_L4_structure/specs/04_structural_test_plan.md`) and latest evidence `QSPI-L4_STRUCTURE-TR-001` (`layer_L4_structure/specs/04_structural_test_report.md`).
...
|-------|------|------|----------|-----------|--------|
| TC-001 | test_idle_cs_n_high | Directed | P1 | Validate idle cs n high. | Planned |
...
| TC ID | Name | Type | Priority | Objective | Status |
| --- | --- | --- | --- | --- | --- |
| QSPI-L5_DSL-TC-001 | test_idle_cs_n_high | Directed | P1 | Validate idle cs n high. | Planned |
| QSPI-L5_DSL-TC-002 | test_xip_read_completes | Directed | P1 | Validate xip read completes. | Planned |

### 7.2 Detailed Test Cases

#### TC-001: test_idle_cs_n_high
| Attribute | Description |
|-----------|-------------|
| Objective | Validate idle cs n high. |
...
|-------------|------|-----------|-------|
| local-pytest | pytest | per flow run | EarphoneQSPI L5 dsl |
