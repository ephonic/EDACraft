# EarphoneQSPI — L5 dsl Test Report — Verification Test Report

| Document ID | QSPI-L5_DSL-TR-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
| Author      | RTLCraft Agent |
| Owner       | Design Team |
| Test Plan Reference | QSPI-L5_DSL-TP-001 |
| Status      | Draft |
...
### 2.2 Scope Summary
EarphoneQSPI L5 dsl layer-local pytest execution with upstream feedback on failures or missing coverage.
...
Command: /opt/anaconda3/bin/python -m pytest /Users/yangfan/release/EDACraft-main/RTLCraft/earphone/modules/qspi/layer_L5_dsl/tests -q --tb=short
...
|-------|------|----------|-------|
| TC-PASS | L5 dsl pytest suite | 0.28s | 2 tests passed |
...
|--------|------|-------|------|------|------|----------|--------|
| qspi-L5_dsl-2026-06-18 | 2026-06-18 | 2 | 2 | 0 | 0 | 0.28s | PASS |

---

## 10. Conclusion

Layer L5 dsl tests completed: 2/2 passed in 0.28s.
...
earphone/modules/qspi/layer_L5_dsl/tests/test_dsl.py ..                  [100%]

============================== 2 passed in 0.10s ===============================

### Appendix B: Tool Command History
/opt/anaconda3/bin/python -m pytest /Users/yangfan/release/EDACraft-main/RTLCraft/earphone/modules/qspi/layer_L5_dsl/tests -q --tb=short
