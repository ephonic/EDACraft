# EarphoneRV32 — L4 structure — Verification Test Plan
...
### 1.1 Purpose
Verification test plan for the L4 structure of EarphoneRV32.
...
|-------------|-------|---------|
| RV32-L4_STRUCTURE-001 | EarphoneRV32 L4 structure specification | 0.1 |
...
| DUT Version | 0.1 |
| Hierarchy Path | earphone.modules.rv32.layer_L4_structure |
...
|-------------|------|-----------|-------|
| local-pytest | pytest | per flow run | EarphoneRV32 L4 structure |
