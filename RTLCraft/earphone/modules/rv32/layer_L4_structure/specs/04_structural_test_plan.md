...
Run the layer-specific pytest suite under earphone/modules/rv32/L4_structure/tests and verify functional equivalence with adjacent layers where applicable.
