# EarphoneRV32 — Verification Test Report

| Document ID | TR-EARPHONE-RV32-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-14 |
| Author      | RTLCraft Agent |
| Owner       | Earphone SoC Team |
| Test Plan Reference | TP-EARPHONE-RV32-001 |
| Status      | Draft |
...
### 1.1 Overall Result
Module tests executed via earphone/flow.py.

### 1.2 Key Metrics
| Metric | Target | Achieved | Status |
|--------|--------|----------|--------|
| Total Test Cases | {{ target_total }} | {{ achieved_total }} | {{ status_total }} |
| Passed | {{ target_pass }} | {{ achieved_pass }} | {{ status_pass }} |
| Failed | {{ target_fail }} | {{ achieved_fail }} | {{ status_fail }} |
| Blocked / Skipped | {{ target_skip }} | {{ achieved_skip }} | {{ status_skip }} |
...
| DUT Version | 0.1 |
| RTL Commit | local dev |
| Testbench Commit | local dev |
...
|-------|-------|--------|--------|---------|
| Unit | {{ unit_total }} | {{ unit_pass }} | {{ unit_fail }} | {{ unit_skip }} |
