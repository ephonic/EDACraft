# EarphoneRV32 — L5 dsl — Verification Test Plan

| Document ID | RV32-L5_DSL-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
...
### 1.1 Purpose
Verification test plan for the L5 dsl of EarphoneRV32.
...
|-------------|-------|---------|
| RV32-L5_DSL-001 | EarphoneRV32 L5 dsl specification | 0.1 |
...
| DUT Version | 0.1 |
| Hierarchy Path | earphone.modules.rv32.layer_L5_dsl |
...
Run the pytest cases listed in `layer_L5_dsl/specs/05_dsl_test_plan.md` under `earphone/modules/rv32/layer_L5_dsl/tests`, then publish PASS/FAIL evidence in `layer_L5_dsl/specs/05_dsl_test_report.md`. Test intent: Consumes approved outputs from `RV32-L4_STRUCTURE-001` (`layer_L4_structure/specs/04_structural_spec.md`), plus verification intent `RV32-L4_STRUCTURE-TP-001` (`layer_L4_structure/specs/04_structural_test_plan.md`) and latest evidence `RV32-L4_STRUCTURE-TR-001` (`layer_L4_structure/specs/04_structural_test_report.md`).
...
|-------|------|------|----------|-----------|--------|
| TC-001 | test_dsl_declares_low_power_and_muldiv_state | Directed | P1 | Validate dsl declares low power and muldiv state. | Planned |
...
| TC ID | Name | Type | Priority | Objective | Status |
| --- | --- | --- | --- | --- | --- |
| RV32-L5_DSL-TC-001 | test_dsl_declares_low_power_and_muldiv_state | Directed | P1 | Validate dsl declares low power and muldiv state. | Planned |
| RV32-L5_DSL-TC-002 | test_dsl_declares_required_external_ports | Directed | P1 | Validate dsl declares required external ports. | Planned |

### 7.2 Detailed Test Cases

#### TC-001: test_dsl_declares_low_power_and_muldiv_state
| Attribute | Description |
|-----------|-------------|
| Objective | Validate dsl declares low power and muldiv state. |
...
|-------------|------|-----------|-------|
| local-pytest | pytest | per flow run | EarphoneRV32 L5 dsl |
