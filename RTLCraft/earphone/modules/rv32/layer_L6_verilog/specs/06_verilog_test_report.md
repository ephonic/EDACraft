# EarphoneRV32 — L6 verilog Test Report — Verification Test Report

| Document ID | RV32-L6_VERILOG-TR-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
| Author      | RTLCraft Agent |
| Owner       | Design Team |
| Test Plan Reference | RV32-L6_VERILOG-TP-001 |
| Status      | Draft |
...
### 2.2 Scope Summary
EarphoneRV32 L6 verilog layer-local pytest execution with upstream feedback on failures or missing coverage.
...
Command: /opt/anaconda3/bin/python -m pytest /Users/yangfan/release/EDACraft-main/RTLCraft/earphone/modules/rv32/layer_L6_verilog/tests -q --tb=short
...
|--------|------|-------|------|------|------|----------|--------|
| rv32-L6_verilog-2026-06-18 | 2026-06-18 | 2 | 2 | 0 | 0 | 0.30s | PASS |
...
earphone/modules/rv32/layer_L6_verilog/tests/test_emitter.py ..          [100%]

============================== 2 passed in 0.14s ===============================

### Appendix B: Tool Command History
/opt/anaconda3/bin/python -m pytest /Users/yangfan/release/EDACraft-main/RTLCraft/earphone/modules/rv32/layer_L6_verilog/tests -q --tb=short
