# EarphoneRV32 — L3 architecture — Verification Test Plan
...
### 1.1 Purpose
Verification test plan for the L3 architecture of EarphoneRV32.
...
|-------------|-------|---------|
| RV32-L3_ARCHITECTURE-001 | EarphoneRV32 L3 architecture specification | 0.1 |
...
| DUT Version | 0.1 |
| Hierarchy Path | earphone.modules.rv32.layer_L3_architecture |
...
|-------------|------|-----------|-------|
| local-pytest | pytest | per flow run | EarphoneRV32 L3 architecture |
