# EarphoneSRAM256K — L6 verilog — Verification Test Plan

| Document ID | SRAM256K-L6_VERILOG-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
...
### 1.1 Purpose
Verification test plan for the L6 verilog of EarphoneSRAM256K.
...
|-------------|-------|---------|
| SRAM256K-L6_VERILOG-001 | EarphoneSRAM256K L6 verilog specification | 0.1 |
...
| DUT Version | 0.1 |
| Hierarchy Path | earphone.modules.sram256k.layer_L6_verilog |
...
| TC ID | Name | Type | Priority | Objective | Status |
| --- | --- | --- | --- | --- | --- |
| SRAM256K-L6_VERILOG-TC-001 | test_emit_verilog_returns_source_and_line_count | Directed | P1 | Validate emit verilog returns source and line count. | Planned |
| SRAM256K-L6_VERILOG-TC-002 | test_emit_verilog_writes_output_file | Directed | P1 | Validate emit verilog writes output file. | Planned |
...
|-------------|------|-----------|-------|
| local-pytest | pytest | per flow run | EarphoneSRAM256K L6 verilog |
