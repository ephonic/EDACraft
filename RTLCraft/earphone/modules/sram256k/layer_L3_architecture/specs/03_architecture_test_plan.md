...
Run the layer-specific pytest suite under earphone/modules/sram256k/L3_architecture/tests and verify functional equivalence with adjacent layers where applicable.
