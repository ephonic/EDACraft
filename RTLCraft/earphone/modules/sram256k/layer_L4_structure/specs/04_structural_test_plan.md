...
Run the layer-specific pytest suite under earphone/modules/sram256k/L4_structure/tests and verify functional equivalence with adjacent layers where applicable.
