# EarphoneSRAM256K — Module Design Specification

| Document ID | SRAM256K-MOD-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
...
### 1.1 Purpose
256 KB on-chip single-port SRAM with APB4 slave port and byte write strobes.
...
### 1.3 Use Cases
Used inside the Smart Earphone SoC as the EarphoneSRAM256K block.

### 1.4 Block Diagram

See layer_L4_structure/specs/04_structural_spec.md for the internal decomposition of EarphoneSRAM256K.
...
EarphoneSRAM256K operation is described per-IR-layer in the layer_L*/specs/ documents.

### 6.2 State Machine(s)

| State | Encoding | Description | Exit Conditions |
|-------|----------|-------------|-----------------|
| Operational | implementation-defined | Normal active state for EarphoneSRAM256K. | Reset, stall, or module-specific completion. |
...
|----|-------------|--------|-------|
| D-01 | sram256k layer contracts, source, tests, reports, and generated RTL where applicable | Markdown, JSON, Python, Verilog | RTLCraft Agent |
