# EarphoneSRAM256K — L5 dsl — Verification Test Plan

| Document ID | SRAM256K-L5_DSL-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
...
### 1.1 Purpose
Verification test plan for the L5 dsl of EarphoneSRAM256K.
...
|-------------|-------|---------|
| SRAM256K-L5_DSL-001 | EarphoneSRAM256K L5 dsl specification | 0.1 |
...
| DUT Version | 0.1 |
| Hierarchy Path | earphone.modules.sram256k.layer_L5_dsl |
...
|-------|------|------|----------|-----------|--------|
| TC-001 | test_byte_masked_write | Directed | P1 | Validate byte masked write. | Planned |
...
| TC ID | Name | Type | Priority | Objective | Status |
| --- | --- | --- | --- | --- | --- |
| SRAM256K-L5_DSL-TC-001 | test_byte_masked_write | Directed | P1 | Validate byte masked write. | Planned |
| SRAM256K-L5_DSL-TC-002 | test_full_word_write_read | Directed | P1 | Validate full word write read. | Planned |
| SRAM256K-L5_DSL-TC-003 | test_unselected_idle | Directed | P1 | Validate unselected idle. | Planned |

### 7.2 Detailed Test Cases

#### TC-001: test_byte_masked_write
| Attribute | Description |
|-----------|-------------|
| Objective | Validate byte masked write. |
...
|-------------|------|-----------|-------|
| local-pytest | pytest | per flow run | EarphoneSRAM256K L5 dsl |
