...
Run the layer-specific pytest suite under earphone/modules/sram256k/L5_dsl/tests and verify functional equivalence with adjacent layers where applicable.
