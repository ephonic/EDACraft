# EarphoneSRAM256K — L5 dsl Test Report — Verification Test Report

| Document ID | SRAM256K-L5_DSL-TR-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-18 |
| Author      | RTLCraft Agent |
| Owner       | Design Team |
| Test Plan Reference | SRAM256K-L5_DSL-TP-001 |
| Status      | Draft |
...
### 2.2 Scope Summary
EarphoneSRAM256K L5 dsl layer-local pytest execution with upstream feedback on failures or missing coverage.
...
Command: /opt/anaconda3/bin/python -m pytest /Users/yangfan/release/EDACraft-main/RTLCraft/earphone/modules/sram256k/layer_L5_dsl/tests -q --tb=short
...
|-------|------|----------|-------|
| TC-PASS | L5 dsl pytest suite | 0.24s | 3 tests passed |
...
|--------------------|--------|----------|-----|--------|
| L5 dsl contract coverage | All directed tests pass | 3/3 | None | OK |
...
|--------|------|-------|------|------|------|----------|--------|
| sram256k-L5_dsl-2026-06-18 | 2026-06-18 | 3 | 3 | 0 | 0 | 0.24s | PASS |

---

## 10. Conclusion

Layer L5 dsl tests completed: 3/3 passed in 0.24s.
...
earphone/modules/sram256k/layer_L5_dsl/tests/test_dsl.py ...             [100%]

============================== 3 passed in 0.08s ===============================

### Appendix B: Tool Command History
/opt/anaconda3/bin/python -m pytest /Users/yangfan/release/EDACraft-main/RTLCraft/earphone/modules/sram256k/layer_L5_dsl/tests -q --tb=short
