...
from rtlgen import FunctionalConstraint, PowerConstraint
...
def generate_constraint_artifacts_and_report():
    """Propagate SpecIR constraints through 6-layer IR and generate artifacts + report."""
    print("\n" + "=" * 70)
    print("Constraint Propagation & Artifact Generation")
    print("=" * 70)
    ...
    for name, mod in modules:
        derived = propagate_module_constraints(mod, propagator)
    ...
    return all_constraints, all_artifacts
