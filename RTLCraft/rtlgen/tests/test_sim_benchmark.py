...
def test_cosim_cache_benchmark_reports_warm_rerun(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("rtlgen.sim.benchmark.run_dsl_rtl_cosim", fake_single_clock_run)
...
def test_cosim_backend_sweep_reports_backend_matrix(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("rtlgen.sim.benchmark.benchmark_cosim_cache", fake_benchmark)
