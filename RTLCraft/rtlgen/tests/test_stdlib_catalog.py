...
from rtlgen.verify import get_stdlib_entry as verify_get_stdlib_entry
from rtlgen.verify import list_stdlib_entries as verify_list_stdlib_entries
...
def test_emit_stdlib_support_matrix_markdown_includes_core_sections():
    ...
    assert "# rtlgen Stdlib Support Matrix" in text
...
def test_stdlib_support_matrix_doc_matches_catalog_generator():
    ...
    matrix_path = repo_root / "rtlgen" / "STDLIB_SUPPORT_MATRIX.md"
