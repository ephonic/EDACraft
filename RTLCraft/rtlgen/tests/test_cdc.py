...
from rtlgen.dsl import Array, AsyncFIFO, DslLoweringReport, Else, If, Input, LoweredDslModule, Module, Output, ReadyValidAsyncBridge, Reg, Wire
from rtlgen.dsl.lib import AsyncResetRel, SyncCell
from rtlgen.dsl.logic import Cat
...
from rtlgen.verify.cdc import analyze_cdc, emit_cdc_report_markdown
...
def test_analyze_cdc_reports_apb_register_bank_raw_async_reset_release():
    from rtlgen.dsl import APBRegisterBank
...
def test_analyze_cdc_ignores_wishbone_register_bank_reset_release():
    from rtlgen.dsl import WishboneRegisterBank
