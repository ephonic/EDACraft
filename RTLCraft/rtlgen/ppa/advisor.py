"""First-pass PPA analysis and recommendation helpers for rtlgen."""
...
from rtlgen.ppa.reports import ImplementationReportBundle
...
def advise_ppa(
    *,
    ...
    if module_stats is not None and module_calibration is not None:
        from rtlgen.ppa.calibration import estimate_calibrated_module_ppa
    ...
    if arch_stats is not None and architecture_calibration is not None:
        from rtlgen.ppa.calibration import estimate_calibrated_architecture_ppa
    ...
    if executable_module is not None:
        from rtlgen.ppa.rewrite import derive_rewrite_proposals
