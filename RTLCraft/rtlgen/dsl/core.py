"""
rtlgen.dsl.core — 基础信号、AST 与模块容器
...
# Re-export from rtlgen.dsl.logic so DSL files can import everything from core.
...
def __getattr__(name: str):
    if name in ("If", "Else", "Elif", "Switch", "Cat", "Rep", "SRA"):
        from rtlgen.dsl.logic import If, Else, Elif, Switch, Cat, Rep, SRA
        return locals()[name]
...
class Expr:
    ...
    def __bool__(self):
        raise TypeError(
            "rtlgen DSL expressions do not support Python truthiness; "
...
class ArrayProxy:
    ...
    def __bool__(self):
        raise TypeError(
            "rtlgen ArrayProxy does not support Python truthiness; "
...
class MemProxy:
    ...
    def __bool__(self):
        raise TypeError(
            "rtlgen MemProxy does not support Python truthiness; "
...
class Signal(IREntity):
    ...
    def __bool__(self):
        raise TypeError(
            "rtlgen Signal does not support Python truthiness; "
...
class Vector:
    ...
    def __bool__(self):
        raise TypeError(
            "rtlgen Vector does not support Python truthiness; "
...
class Parameter:
    ...
    def __bool__(self):
        raise TypeError(
            "rtlgen Parameter does not support Python truthiness inside authored DSL logic; "
    ...
    def _capture_location(cls) -> Optional[SourceLoc]:
        ...
        try:
            ...
            while frame is not None:
                ...
                if not normalized.endswith("/rtlgen/core.py") and not normalized.endswith("/rtlgen/dsl/core.py"):
...
class Array:
    ...
    def __bool__(self):
        raise TypeError(
            "rtlgen Array does not support Python truthiness; "
