...
```python
from rtlgen.archsim import build_npu_systolic_scenario
...
```python
from rtlgen.archsim import infer_architecture_from_module, infer_flow_from_module
...
```python
from rtlgen.archsim import BehaviorSimulator
...
```python
from rtlgen.archsim import CycleSimulator
...
```python
from rtlgen.archsim import run_stage_bandwidth_sweep
...
```python
from rtlgen.archsim import run_stage_capacity_sweep
...
```python
from rtlgen.archsim import run_stage_latency_sweep
...
```python
from rtlgen.archsim import run_stage_queue_depth_sweep, run_stage_initiation_interval_sweep
...
```python
from rtlgen.ppa import PpaGoals, advise_ppa
...
```python
from rtlgen.ppa import analyze_module_ppa, advise_ppa
...
```python
from rtlgen.ppa import load_implementation_report_bundle, advise_ppa
...
```python
from rtlgen.dsl import ReqRspQueue
from rtlgen.ppa import PpaGoals, advise_ppa, emit_ppa_report_markdown
...
```python
from rtlgen.dsl import AXI4LiteRegisterBank
from rtlgen.ppa import PpaGoals, advise_ppa, emit_ppa_report_markdown
