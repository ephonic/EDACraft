"""Public standard-library catalog for rtlgen.
...
with the documented support-matrix language used elsewhere in rtlgen.
"""
...
_STDLIB_ENTRIES: Tuple[StdlibEntry, ...] = (
    StdlibEntry(
        ...
        public_api=(
            "rtlgen.dsl.ReadyValid",
            "rtlgen.verify.ready_valid_sequence",
            "rtlgen.verify.ready_valid_reference_model",
            "rtlgen.verify.check_ready_valid_trace",
        ),
    ...
    StdlibEntry(
        ...
        public_api=(
            "rtlgen.dsl.ReqRsp",
            "rtlgen.verify.req_rsp_sequence",
            "rtlgen.verify.req_rsp_reference_model",
            "rtlgen.verify.check_reqrsp_trace",
        ),
    ...
    StdlibEntry(
        ...
        public_api=(
            "rtlgen.dsl.APB",
            "rtlgen.verify.apb_sequence",
            "rtlgen.verify.apb_reference_model",
            "rtlgen.verify.get_protocol_vip_kit('apb')",
        ),
    ...
    StdlibEntry(
        ...
        public_api=(
            "rtlgen.dsl.AXI4Lite",
            "rtlgen.verify.axilite_protocol_sequence",
            "rtlgen.verify.axilite_reference_model",
            "rtlgen.verify.get_protocol_vip_kit('axilite')",
        ),
    ...
    StdlibEntry(
        ...
        public_api=(
            "rtlgen.dsl.AXI4Stream",
            "rtlgen.verify.axistream_sequence",
            "rtlgen.verify.axistream_reference_model",
            "rtlgen.verify.get_protocol_vip_kit('axis')",
        ),
    ...
    StdlibEntry(
        ...
        public_api=(
            "rtlgen.dsl.Wishbone",
            "rtlgen.verify.wishbone_protocol_sequence",
            "rtlgen.verify.wishbone_reference_model",
            "rtlgen.verify.get_protocol_vip_kit('wishbone')",
        ),
    ...
    StdlibEntry(
        ...
        public_api=(
            "rtlgen.dsl.AHBLite",
            "rtlgen.verify.ahblite_sequence",
            "rtlgen.verify.ahblite_reference_model",
            "rtlgen.verify.get_protocol_vip_kit('ahb_lite')",
        ),
        related=("AHBLiteVIP",),
    ...
    StdlibEntry(
        ...
        public_api=("rtlgen.dsl.ReadyValidRegister",),
        related=("ReadyValid", "ReadyValidVIP"),
        notes="Regression-covered through lowering, simulation, emitted RTL, Python-UVM, and generated directed UVM collateral/runtime bundle; broader external-simulator UVM closure remains intentionally partial.",
    ),
    StdlibEntry(
        name="ReadyValidFIFO",
        kind="component",
    ...
    StdlibEntry(
        ...
        public_api=("rtlgen.dsl.ReadyValidAsyncBridge",),
        related=("ReadyValid", "AsyncFIFO"),
        notes="Lowering, Python/C++ multi-clock simulation, Python-UVM, and generated multi-clock UVM collateral are regression-covered; broader external simulator closure remains intentionally partial.",
    ),
    StdlibEntry(
        name="ReqRspQueue",
        kind="component",
        ...
        public_api=("rtlgen.dsl.ReqRspQueue",),
    ...
    StdlibEntry(
        ...
        public_api=("rtlgen.dsl.SyncFIFO",),
        related=("AsyncFIFO",),
        notes="Lowering, Python/C++ simulation, Python-UVM, and generated directed UVM collateral are regression-covered for the current single-clock FIFO behavior; broader protocol-aware queue family standardization remains lighter here.",
    ),
    StdlibEntry(
        name="AsyncFIFO",
        kind="component",
    ...
    StdlibEntry(
        ...
        public_api=("rtlgen.dsl.SignedMultiplier",),
        related=("MAC",),
    ...
    StdlibEntry(
        ...
        public_api=("rtlgen.dsl.DualPortRAM",),
    ...
    StdlibEntry(
        ...
        public_api=(
            "rtlgen.verify.get_protocol_vip_kit('ready_valid')",
            "rtlgen.verify.protocol_transfers_to_uvm_sequence_steps",
        ),
    ...
    StdlibEntry(
        ...
        public_api=("rtlgen.verify.get_protocol_vip_kit('req_rsp')",),
    ...
    StdlibEntry(
        ...
        public_api=(
            "rtlgen.verify.get_protocol_vip_kit('apb')",
            "rtlgen.verify.protocol_transfers_to_uvm_sequence_steps('apb', ...)",
        ),
    ...
    StdlibEntry(
        ...
        public_api=(
            "rtlgen.verify.get_protocol_vip_kit('axilite')",
            "rtlgen.verify.protocol_transfers_to_uvm_sequence_steps('axilite', ...)",
        ),
    ...
    StdlibEntry(
        ...
        public_api=(
            "rtlgen.verify.get_protocol_vip_kit('axis')",
            "rtlgen.verify.protocol_transfers_to_uvm_sequence_steps('axis', ...)",
        ),
        related=("AXI4Stream",),
    ...
    StdlibEntry(
        ...
        public_api=("rtlgen.verify.get_protocol_vip_kit('wishbone')",),
    ...
    StdlibEntry(
        ...
        public_api=(
            "rtlgen.verify.get_protocol_vip_kit('wishbone_clocked')",
            "rtlgen.verify.protocol_transfers_to_uvm_sequence_steps('wishbone_clocked', ...)",
        ),
    ...
    StdlibEntry(
        ...
        public_api=("rtlgen.verify.get_protocol_vip_kit('ahb_lite')",),
        related=("AHBLite",),
