...
from rtlgen.verify.directed import StepVector, TraceSample, VerificationFailure
    ...
    *,
    ...
    if isinstance(module, SimModule):
        raise TypeError(
            ...
            "Pass a rtlgen.dsl.Module instance."
        )
    if not (hasattr(module, "_inputs") and hasattr(module, "_outputs") and hasattr(module, "_seq_blocks")):
        raise TypeError(
            "run_python_uvm_rtl_test(...) expects an authored rtlgen.dsl.Module because "
