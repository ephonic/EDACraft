"""
skills.image.isp.behaviors — ISP Behavior Templates

Domain-specific behavior templates for Image Signal Processor pipeline stages.
...
Pipeline order:
  ...
  IO:    AXI-In, AXI-Out, APB-Regs
  Stats: AWB-Stats, AE-Stats
"""
