"""
skills.mem.ddr3.behaviors — DDR3 Controller Behavior Templates

Domain-specific behavior templates for DDR3 memory controllers.
These are registered into the TemplateRegistry at import time.

Templates:
  - memory_controller_template: Core FSM (INIT → IDLE → ACT → READ/WRITE → PRE → REF)
  - dfi_sequencer_template: DFI command timing + data serialization
"""
...
# =====================================================================
# Memory Controller — DDR3/DDR4/LPDDR5 Controller FSM Behavior Template
# =====================================================================
