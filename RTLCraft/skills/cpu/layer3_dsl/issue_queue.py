...
class IssueQueue(Module):
    def __init__(self):
        ...
        self.op_t = Array(6, 16, "op_t")
        self.prd_t = Array(7, 16, "prd_t")
        self.vld_t = Array(1, 16, "vld_t")
        self.rdy1_t = Array(1, 16, "rdy1_t")
        self.rdy2_t = Array(1, 16, "rdy2_t")
        self.prs1_t = Array(64, 16, "prs1_t")
        self.prs2_t = Array(64, 16, "prs2_t")
            ...
            with Else():
                ...
                with If((self.wakeup_en == 1)):
                    ...
                    with If((self.vld_t[3] == 1) & (self.prs2_t[3] == self.wakeup_pr)):
                        self.rdy2_t[3] <<= 1
                    with If((self.vld_t[4] == 1) & (self.prs1_t[4] == self.wakeup_pr)):
                        self.rdy1_t[4] <<= 1
                    with If((self.vld_t[4] == 1) & (self.prs2_t[4] == self.wakeup_pr)):
                        self.rdy2_t[4] <<= 1
                    with If((self.vld_t[5] == 1) & (self.prs1_t[5] == self.wakeup_pr)):
                        self.rdy1_t[5] <<= 1
                    with If((self.vld_t[5] == 1) & (self.prs2_t[5] == self.wakeup_pr)):
                        self.rdy2_t[5] <<= 1
                    with If((self.vld_t[6] == 1) & (self.prs1_t[6] == self.wakeup_pr)):
                        self.rdy1_t[6] <<= 1
                    with If((self.vld_t[6] == 1) & (self.prs2_t[6] == self.wakeup_pr)):
                        self.rdy2_t[6] <<= 1
                    with If((self.vld_t[7] == 1) & (self.prs1_t[7] == self.wakeup_pr)):
                        self.rdy1_t[7] <<= 1
                    with If((self.vld_t[7] == 1) & (self.prs2_t[7] == self.wakeup_pr)):
                        self.rdy2_t[7] <<= 1
