"""
skills.interfaces.axis.behaviors — AXI-Stream Behavior Templates

Domain-specific behavior templates for AXI-Stream components.
Registered into TemplateRegistry at import time.

Components:
  - axis_register:  Skid buffer register (bubble-free 1-cycle pipeline)
  - axis_adapter:   Width up-size adapter (narrow→wide, segment collection)
  - axis_broadcast: 1-to-M broadcaster with skid buffer back-pressure

Reference: ref_rtl/interfaces/axis/rtl/axis_register.v, axis_adapter.v, axis_broadcast.v
"""
...
# =====================================================================
# AXIS_REGISTER Template
# =====================================================================

def axis_register_template(
    data_width: int = 8,
    **kwargs,
...
TemplateRegistry.register("axis_register", axis_register_template)
TemplateRegistry.register("axis_adapter", axis_adapter_template)
TemplateRegistry.register("axis_broadcast", axis_broadcast_template)
