"""
skills.interfaces.i2c.cycle_level — Cycle-Level Models (register-accurate)
"""
...
def i2_c_single_reg_cycle(**kwargs) -> Callable[[CycleContext], None]:
    """Cycle-accurate I2C_SINGLE_REG model."""
...
_template_map = {
    "i2_c_single_reg": i2_c_single_reg_cycle,
    "i2c_single_reg": i2c_single_reg_cycle,
}

for _name, _tmpl in _template_map.items():
    TemplateRegistry.register(_name, _tmpl)

i2_c_single_reg_template = i2_c_single_reg_cycle
i2c_single_reg_template = i2c_single_reg_cycle
