...
- `input [47:0] s_ip_eth_dest_mac`
- `input [47:0] s_ip_eth_src_mac`
- `input [15:0] s_ip_eth_type`
...
- `input [47:0] s_udp_eth_dest_mac`
- `input [47:0] s_udp_eth_src_mac`
- `input [15:0] s_udp_eth_type`
- `input [3:0] s_udp_ip_version`
- `input [3:0] s_udp_ip_ihl`
- `input [5:0] s_udp_ip_dscp`
- `input [1:0] s_udp_ip_ecn`
- `input [15:0] s_udp_ip_identification`
- `input [2:0] s_udp_ip_flags`
- `input [12:0] s_udp_ip_fragment_offset`
- `input [7:0] s_udp_ip_ttl`
- `input [15:0] s_udp_ip_header_checksum`
