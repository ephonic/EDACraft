"""
skills.interfaces.wishbone.cycle_level — Cycle-Level Models (register-accurate)
"""
...
wb_mux_2_template = wb_mux_2_cycle
wb_reg_template = wb_reg_cycle
