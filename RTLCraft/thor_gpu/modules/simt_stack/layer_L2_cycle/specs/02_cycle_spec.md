# ThorSIMTStack — L2 cycle Specification

| Document ID | SIMT_STACK-L2_CYCLE-001 |
|-------------|--------------|
| Layer       | L2 cycle |
...
### 1.1 Purpose
Cycle-level SIMT divergence/reconvergence stack.

### 1.2 Scope
Cycle-accurate timing and protocol behavior of ThorSIMTStack.

---

## 2. Inputs from Previous Layer

Consumes approved outputs from `SIMT_STACK-L1_BEHAVIOR-001` (`layer_L1_behavior/specs/01_behavior_spec.md`) as input to `SIMT_STACK-L2_CYCLE-001`.

---

## 3. Outputs to Next Layer

Emits `SIMT_STACK-L2_CYCLE-001` (`layer_L2_cycle/specs/02_cycle_spec.md`) as input to `SIMT_STACK-L3_ARCHITECTURE-001` (`layer_L3_architecture/specs/03_architecture_spec.md`).
...
| --- | --- |
| Latency Cycles | 1 |
| Pipeline Stages | stack_update, output |
