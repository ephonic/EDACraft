# ThorSIMTStack — L1 behavior Specification

| Document ID | SIMT_STACK-L1_BEHAVIOR-001 |
|-------------|--------------|
| Layer       | L1 behavior |
...
### 1.1 Purpose
SIMT divergence/reconvergence stack functional reference.

### 1.2 Scope
Cycle-unaware functional behavior of ThorSIMTStack.

---

## 2. Inputs from Previous Layer

Consumes the module contract `SIMT_STACK-MOD-001` and the Thor-GPGPU top-level SoC requirements as the seed SpecIR.

---

## 3. Outputs to Next Layer

Emits `SIMT_STACK-L1_BEHAVIOR-001` (`layer_L1_behavior/specs/01_behavior_spec.md`) as input to `SIMT_STACK-L2_CYCLE-001` (`layer_L2_cycle/specs/02_cycle_spec.md`).
...
| Mask Width | 8 |
| Max Depth | 8 |
| Frame Fields | reconverge_pc, not_taken_mask |
