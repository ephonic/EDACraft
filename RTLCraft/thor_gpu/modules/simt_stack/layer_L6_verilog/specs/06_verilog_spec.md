# ThorSIMTStack — L6 verilog Specification

| Document ID | SIMT_STACK-L6_VERILOG-001 |
|-------------|--------------|
| Layer       | L6 verilog |
...
### 1.1 Purpose
Verilog emission wrapper for the Thor SIMT stack DSL contract.

### 1.2 Scope
Generated Verilog RTL and reports for ThorSIMTStack.

---

## 2. Inputs from Previous Layer

Consumes approved outputs from `SIMT_STACK-L5_DSL-001` (`layer_L5_dsl/specs/05_dsl_spec.md`) as input to `SIMT_STACK-L6_VERILOG-001`.

---

## 3. Outputs to Next Layer

Emits the final RTL-generation contract `SIMT_STACK-L6_VERILOG-001` (`layer_L6_verilog/specs/06_verilog_spec.md`) for module-level sign-off.
...
| Property | Value |
| --- | --- |
| File Name | thor_simt_stack.v |
| Dsl Class | ThorSIMTStack |
| Key Ports | push, pop, next_pc, next_mask, stack_depth |
