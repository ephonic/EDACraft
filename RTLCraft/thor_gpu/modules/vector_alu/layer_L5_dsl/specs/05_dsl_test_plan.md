# ThorVectorALU — L5 dsl — Verification Test Plan

| Document ID | VECTOR_ALU-L5_DSL-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L5 dsl of ThorVectorALU.
...
|-------------|-------|---------|
| VECTOR_ALU-L5_DSL-001 | ThorVectorALU L5 dsl specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/vector_alu/layer_L5_dsl/tests`.
...
|-------|------|------|----------|-----------|--------|
| TC-001 | test_add_cross_layer | {{ tc_type_01 }} | {{ tc_prio_01 }} | Validate add cross layer. | {{ tc_status_01 }} |

### 7.2 Detailed Test Cases

#### TC-001: test_add_cross_layer
| Attribute | Description |
|-----------|-------------|
| Objective | Validate add cross layer. |
