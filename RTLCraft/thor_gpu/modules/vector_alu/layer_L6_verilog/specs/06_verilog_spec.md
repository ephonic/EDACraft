# ThorVectorALU — L6 verilog Specification

| Document ID | VECTOR_ALU-L6_VERILOG-001 |
|-------------|--------------|
| Layer       | L6 verilog |
...
### 1.1 Purpose
Verilog emission wrapper for the Thor vector ALU DSL contract.

### 1.2 Scope
Generated Verilog RTL and reports for ThorVectorALU.

---

## 2. Inputs from Previous Layer

Consumes approved outputs from `VECTOR_ALU-L5_DSL-001` (`layer_L5_dsl/specs/05_dsl_spec.md`) as input to `VECTOR_ALU-L6_VERILOG-001`.

---

## 3. Outputs to Next Layer

Emits the final RTL-generation contract `VECTOR_ALU-L6_VERILOG-001` (`layer_L6_verilog/specs/06_verilog_spec.md`) for module-level sign-off.
...
| Property | Value |
| --- | --- |
| File Name | thor_vector_alu.v |
| Dsl Class | ThorVectorALU |
| Key Ports | src1, src2, result, active_mask, alu_fn |
