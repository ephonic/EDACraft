# ThorVectorALU — L6 verilog — Verification Test Plan

| Document ID | VECTOR_ALU-L6_VERILOG-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L6 verilog of ThorVectorALU.
...
|-------------|-------|---------|
| VECTOR_ALU-L6_VERILOG-001 | ThorVectorALU L6 verilog specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/vector_alu/layer_L6_verilog/tests`.
