# ThorVectorALU — L4 structure — Verification Test Plan

| Document ID | VECTOR_ALU-L4_STRUCTURE-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L4 structure of ThorVectorALU.
...
|-------------|-------|---------|
| VECTOR_ALU-L4_STRUCTURE-001 | ThorVectorALU L4 structure specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/vector_alu/layer_L4_structure/tests`.
