# ThorVectorALU — L1 behavior — Verification Test Plan

| Document ID | VECTOR_ALU-L1_BEHAVIOR-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L1 behavior of ThorVectorALU.
...
|-------------|-------|---------|
| VECTOR_ALU-L1_BEHAVIOR-001 | ThorVectorALU L1 behavior specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/vector_alu/layer_L1_behavior/tests`.
...
|-------|------|------|----------|-----------|--------|
| TC-001 | test_active_mask_predication | {{ tc_type_01 }} | {{ tc_prio_01 }} | Validate active mask predication. | {{ tc_status_01 }} |

### 7.2 Detailed Test Cases

#### TC-001: test_active_mask_predication
| Attribute | Description |
|-----------|-------------|
| Objective | Validate active mask predication. |
