# ThorVectorALU — Module Design Specification

| Document ID | VECTOR_ALU-MOD-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
| Author      | RTLCraft Agent |
| Owner       | Design Team |
| Module ID   | VECTOR_ALU |
| Status      | Draft |
...
### 1.1 Purpose
8-lane INT32 vector ALU with per-lane active-mask predication (1-cycle registered).
