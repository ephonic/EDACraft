# ThorVectorALU — L2 cycle — Verification Test Plan

| Document ID | VECTOR_ALU-L2_CYCLE-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L2 cycle of ThorVectorALU.
...
|-------------|-------|---------|
| VECTOR_ALU-L2_CYCLE-001 | ThorVectorALU L2 cycle specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/vector_alu/layer_L2_cycle/tests`.
...
|-------|------|------|----------|-----------|--------|
| TC-001 | test_add_one_cycle | {{ tc_type_01 }} | {{ tc_prio_01 }} | Validate add one cycle. | {{ tc_status_01 }} |

### 7.2 Detailed Test Cases

#### TC-001: test_add_one_cycle
| Attribute | Description |
|-----------|-------------|
| Objective | Validate add one cycle. |
