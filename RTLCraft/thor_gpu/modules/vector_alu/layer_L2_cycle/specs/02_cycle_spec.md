# ThorVectorALU — L2 cycle Specification

| Document ID | VECTOR_ALU-L2_CYCLE-001 |
|-------------|--------------|
| Layer       | L2 cycle |
...
### 1.1 Purpose
1-cycle registered 8-lane INT32 ALU with active-mask predication.

### 1.2 Scope
Cycle-accurate timing and protocol behavior of ThorVectorALU.

---

## 2. Inputs from Previous Layer

Consumes approved outputs from `VECTOR_ALU-L1_BEHAVIOR-001` (`layer_L1_behavior/specs/01_behavior_spec.md`) as input to `VECTOR_ALU-L2_CYCLE-001`.

---

## 3. Outputs to Next Layer

Emits `VECTOR_ALU-L2_CYCLE-001` (`layer_L2_cycle/specs/02_cycle_spec.md`) as input to `VECTOR_ALU-L3_ARCHITECTURE-001` (`layer_L3_architecture/specs/03_architecture_spec.md`).
...
| --- | --- |
| Latency Cycles | 1 |
| Pipeline Stages | execute, writeback_reg |
