# ThorWarpScheduler — L5 dsl Test Report — Verification Test Report

| Document ID | WARP_SCHEDULER-L5_DSL-TR-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
| Author      | RTLCraft Agent |
| Owner       | Design Team |
| Test Plan Reference | WARP_SCHEDULER-L5_DSL-TP-001 |
| Status      | Draft |
...
L5 dsl tests: 4/4 passed in 0.25s.
...
thor_gpu/modules/warp_scheduler/layer_L5_dsl/tests/test_dsl.py ....      [100%]
