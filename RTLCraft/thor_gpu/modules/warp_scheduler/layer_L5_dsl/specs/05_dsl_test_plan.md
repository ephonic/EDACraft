# ThorWarpScheduler — L5 dsl — Verification Test Plan

| Document ID | WARP_SCHEDULER-L5_DSL-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L5 dsl of ThorWarpScheduler.
...
|-------------|-------|---------|
| WARP_SCHEDULER-L5_DSL-001 | ThorWarpScheduler L5 dsl specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/warp_scheduler/layer_L5_dsl/tests`.
...
|-------|------|------|----------|-----------|--------|
| TC-001 | test_advance_when_current_idle | {{ tc_type_01 }} | {{ tc_prio_01 }} | Validate advance when current idle. | {{ tc_status_01 }} |

### 7.2 Detailed Test Cases

#### TC-001: test_advance_when_current_idle
| Attribute | Description |
|-----------|-------------|
| Objective | Validate advance when current idle. |
