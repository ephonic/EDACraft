# ThorWarpScheduler — L5 dsl Specification

| Document ID | WARP_SCHEDULER-L5_DSL-001 |
|-------------|--------------|
| Layer       | L5 dsl |
...
### 1.1 Purpose
RTL-ready sticky-RR warp scheduler (4 warps) with barrier sync.

### 1.2 Scope
RTL-ready DSL description of ThorWarpScheduler.

---

## 2. Inputs from Previous Layer

Consumes approved outputs from `WARP_SCHEDULER-L4_STRUCTURE-001` (`layer_L4_structure/specs/04_structural_spec.md`) as input to `WARP_SCHEDULER-L5_DSL-001`.

---

## 3. Outputs to Next Layer

Emits `WARP_SCHEDULER-L5_DSL-001` (`layer_L5_dsl/specs/05_dsl_spec.md`) as input to `WARP_SCHEDULER-L6_VERILOG-001` (`layer_L6_verilog/specs/06_verilog_spec.md`).
...
`warp_idle[4], warp_done[4], warp_at_barrier[4] -> warp_sel[2], barrier_release, sm_done`
