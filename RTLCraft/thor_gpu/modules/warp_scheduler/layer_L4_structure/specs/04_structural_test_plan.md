# ThorWarpScheduler — L4 structure — Verification Test Plan

| Document ID | WARP_SCHEDULER-L4_STRUCTURE-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L4 structure of ThorWarpScheduler.
...
|-------------|-------|---------|
| WARP_SCHEDULER-L4_STRUCTURE-001 | ThorWarpScheduler L4 structure specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/warp_scheduler/layer_L4_structure/tests`.
...
|-------|------|------|----------|-----------|--------|
| TC-001 | test_describe | {{ tc_type_01 }} | {{ tc_prio_01 }} | Validate describe. | {{ tc_status_01 }} |
