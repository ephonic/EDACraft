# ThorWarpScheduler — L2 cycle Specification

| Document ID | WARP_SCHEDULER-L2_CYCLE-001 |
|-------------|--------------|
| Layer       | L2 cycle |
...
### 1.1 Purpose
Cycle-level sticky-RR warp scheduler with registered warp_sel.

### 1.2 Scope
Cycle-accurate timing and protocol behavior of ThorWarpScheduler.

---

## 2. Inputs from Previous Layer

Consumes approved outputs from `WARP_SCHEDULER-L1_BEHAVIOR-001` (`layer_L1_behavior/specs/01_behavior_spec.md`) as input to `WARP_SCHEDULER-L2_CYCLE-001`.

---

## 3. Outputs to Next Layer

Emits `WARP_SCHEDULER-L2_CYCLE-001` (`layer_L2_cycle/specs/02_cycle_spec.md`) as input to `WARP_SCHEDULER-L3_ARCHITECTURE-001` (`layer_L3_architecture/specs/03_architecture_spec.md`).
...
| --- | --- |
| Latency Cycles | 1 |
| Pipeline Stages | decision, warp_sel_register |
