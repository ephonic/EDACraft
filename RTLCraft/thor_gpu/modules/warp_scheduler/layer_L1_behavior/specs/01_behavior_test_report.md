# ThorWarpScheduler — L1 behavior Test Report — Verification Test Report

| Document ID | WARP_SCHEDULER-L1_BEHAVIOR-TR-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
| Author      | RTLCraft Agent |
| Owner       | Design Team |
| Test Plan Reference | WARP_SCHEDULER-L1_BEHAVIOR-TP-001 |
| Status      | Draft |
...
L1 behavior tests: 8/8 passed in 0.17s.
...
thor_gpu/modules/warp_scheduler/layer_L1_behavior/tests/test_behavior.py . [ 12%]
.......                                                                  [100%]
...
|---------|------|--------|-------------|
| 0.1 | 2026-06-17 | RTLCraft Agent | Initial report. |
