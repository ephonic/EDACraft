# ThorWarpScheduler — L1 behavior Specification

| Document ID | WARP_SCHEDULER-L1_BEHAVIOR-001 |
|-------------|--------------|
| Layer       | L1 behavior |
...
### 1.2 Scope
Cycle-unaware functional behavior of ThorWarpScheduler.

---

## 2. Inputs from Previous Layer

Consumes the module contract `WARP_SCHEDULER-MOD-001` and the Thor-GPGPU top-level SoC requirements as the seed SpecIR.

---

## 3. Outputs to Next Layer

Emits `WARP_SCHEDULER-L1_BEHAVIOR-001` (`layer_L1_behavior/specs/01_behavior_spec.md`) as input to `WARP_SCHEDULER-L2_CYCLE-001` (`layer_L2_cycle/specs/02_cycle_spec.md`).
