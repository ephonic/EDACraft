# ThorWarpScheduler — L3 architecture — Verification Test Plan

| Document ID | WARP_SCHEDULER-L3_ARCHITECTURE-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L3 architecture of ThorWarpScheduler.
...
|-------------|-------|---------|
| WARP_SCHEDULER-L3_ARCHITECTURE-001 | ThorWarpScheduler L3 architecture specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/warp_scheduler/layer_L3_architecture/tests`.
...
|-------|------|------|----------|-----------|--------|
| TC-001 | test_arch_contract | {{ tc_type_01 }} | {{ tc_prio_01 }} | Validate arch contract. | {{ tc_status_01 }} |

### 7.2 Detailed Test Cases

#### TC-001: test_arch_contract
| Attribute | Description |
|-----------|-------------|
| Objective | Validate arch contract. |
