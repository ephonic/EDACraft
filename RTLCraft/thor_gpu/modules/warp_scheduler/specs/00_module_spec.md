# ThorWarpScheduler — Module Design Specification

| Document ID | WARP_SCHEDULER-MOD-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
| Author      | RTLCraft Agent |
| Owner       | Design Team |
| Module ID   | WARP_SCHEDULER |
| Status      | Draft |
...
### 1.1 Purpose
Sticky round-robin warp scheduler (4 warps) with barrier synchronization.
