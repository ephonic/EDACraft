# ThorWarpScheduler — L1 behavior — Verification Test Plan

| Document ID | WARP_SCHEDULER-L1_BEHAVIOR-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L1 behavior of ThorWarpScheduler.
...
|-------------|-------|---------|
| WARP_SCHEDULER-L1_BEHAVIOR-001 | ThorWarpScheduler L1 behavior specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/warp_scheduler/layer_L1_behavior/tests`.
...
|-------|------|------|----------|-----------|--------|
| TC-001 | test_advance_when_idle | {{ tc_type_01 }} | {{ tc_prio_01 }} | Validate advance when idle. | {{ tc_status_01 }} |

### 7.2 Detailed Test Cases

#### TC-001: test_advance_when_idle
| Attribute | Description |
|-----------|-------------|
| Objective | Validate advance when idle. |
