# ThorVectorFPU — L6 verilog Test Report — Verification Test Report

| Document ID | VECTOR_FPU-L6_VERILOG-TR-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
| Author      | RTLCraft Agent |
| Owner       | Design Team |
| Test Plan Reference | VECTOR_FPU-L6_VERILOG-TP-001 |
| Status      | Draft |
...
thor_gpu/modules/vector_fpu/layer_L6_verilog/tests/test_verilog.py ..    [100%]
