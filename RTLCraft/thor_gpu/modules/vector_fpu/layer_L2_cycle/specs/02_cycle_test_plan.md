# ThorVectorFPU — L2 cycle — Verification Test Plan

| Document ID | VECTOR_FPU-L2_CYCLE-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L2 cycle of ThorVectorFPU.
...
|-------------|-------|---------|
| VECTOR_FPU-L2_CYCLE-001 | ThorVectorFPU L2 cycle specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/vector_fpu/layer_L2_cycle/tests`.
