# ThorVectorFPU — L1 behavior — Verification Test Plan

| Document ID | VECTOR_FPU-L1_BEHAVIOR-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L1 behavior of ThorVectorFPU.
...
|-------------|-------|---------|
| VECTOR_FPU-L1_BEHAVIOR-001 | ThorVectorFPU L1 behavior specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/vector_fpu/layer_L1_behavior/tests`.
...
|-------|------|------|----------|-----------|--------|
| TC-001 | test_fadd | {{ tc_type_01 }} | {{ tc_prio_01 }} | Validate fadd. | {{ tc_status_01 }} |
