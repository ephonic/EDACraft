# ThorVectorFPU — L4 structure Specification

| Document ID | VECTOR_FPU-L4_STRUCTURE-001 |
|-------------|--------------|
| Layer       | L4 structure |
...
### 1.1 Purpose
Decomposition into FP lane array, mask decode, and result register.

### 1.2 Scope
Structural decomposition of ThorVectorFPU.

---

## 2. Inputs from Previous Layer

Consumes approved outputs from `VECTOR_FPU-L3_ARCHITECTURE-001` (`layer_L3_architecture/specs/03_architecture_spec.md`) as input to `VECTOR_FPU-L4_STRUCTURE-001`.

---

## 3. Outputs to Next Layer

Emits `VECTOR_FPU-L4_STRUCTURE-001` (`layer_L4_structure/specs/04_structural_spec.md`) as input to `VECTOR_FPU-L5_DSL-001` (`layer_L5_dsl/specs/05_dsl_spec.md`).
...
| Property | Value |
| --- | --- |
| Subblocks | fp_lane_array, active_mask_decode, result_register |
