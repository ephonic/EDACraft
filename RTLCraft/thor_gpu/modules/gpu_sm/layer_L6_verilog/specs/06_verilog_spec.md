# ThorGpuSM — L6 verilog Specification

| Document ID | GPU_SM-L6_VERILOG-001 |
|-------------|--------------|
| Layer       | L6 verilog |
| Module      | ThorGpuSM |
| Version     | 0.1 |
...
### 1.1 Purpose
Verilog emission wrapper for the Thor SM DSL contract.

### 1.2 Scope
Generated Verilog RTL and reports for ThorGpuSM.

---

## 2. Inputs from Previous Layer

Consumes approved outputs from `GPU_SM-L5_DSL-001` (`layer_L5_dsl/specs/05_dsl_spec.md`) as input to `GPU_SM-L6_VERILOG-001`.

---

## 3. Outputs to Next Layer

Emits the final RTL-generation contract `GPU_SM-L6_VERILOG-001` (`layer_L6_verilog/specs/06_verilog_spec.md`) for module-level sign-off.
...
| Property | Value |
| --- | --- |
| File Name | thor_gpu_sm.v |
| Dsl Class | ThorGpuSM |
| Key Ports | sm_done, debug_w0_acc0, imem_wr_en, start |
