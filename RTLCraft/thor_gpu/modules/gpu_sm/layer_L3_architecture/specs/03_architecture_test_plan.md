# ThorGpuSM — L3 architecture — Verification Test Plan

| Document ID | GPU_SM-L3_ARCHITECTURE-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L3 architecture of ThorGpuSM.
...
|-------------|-------|---------|
| GPU_SM-L3_ARCHITECTURE-001 | ThorGpuSM L3 architecture specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/gpu_sm/layer_L3_architecture/tests`.
