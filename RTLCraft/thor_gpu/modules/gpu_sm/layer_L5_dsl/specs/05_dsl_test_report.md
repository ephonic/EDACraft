# ThorGpuSM — L5 dsl Test Report — Verification Test Report

| Document ID | GPU_SM-L5_DSL-TR-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
| Author      | RTLCraft Agent |
| Owner       | Design Team |
| Test Plan Reference | GPU_SM-L5_DSL-TP-001 |
| Status      | Draft |
...
L5 dsl tests: 3/3 passed in 0.23s.
...
thor_gpu/modules/gpu_sm/layer_L5_dsl/tests/test_dsl.py ...               [100%]
