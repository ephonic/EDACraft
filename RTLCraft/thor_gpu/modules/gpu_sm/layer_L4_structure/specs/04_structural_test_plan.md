# ThorGpuSM — L4 structure — Verification Test Plan

| Document ID | GPU_SM-L4_STRUCTURE-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L4 structure of ThorGpuSM.
...
|-------------|-------|---------|
| GPU_SM-L4_STRUCTURE-001 | ThorGpuSM L4 structure specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/gpu_sm/layer_L4_structure/tests`.
