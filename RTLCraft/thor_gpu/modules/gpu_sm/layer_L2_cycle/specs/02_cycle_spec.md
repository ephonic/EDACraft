# ThorGpuSM — L2 cycle Specification

| Document ID | GPU_SM-L2_CYCLE-001 |
|-------------|--------------|
| Layer       | L2 cycle |
| Module      | ThorGpuSM |
| Version     | 0.1 |
...
### 1.1 Purpose
Cycle-level SM model delegating functional execution to L1.

### 1.2 Scope
Cycle-accurate timing and protocol behavior of ThorGpuSM.

---

## 2. Inputs from Previous Layer

Consumes approved outputs from `GPU_SM-L1_BEHAVIOR-001` (`layer_L1_behavior/specs/01_behavior_spec.md`) as input to `GPU_SM-L2_CYCLE-001`.

---

## 3. Outputs to Next Layer

Emits `GPU_SM-L2_CYCLE-001` (`layer_L2_cycle/specs/02_cycle_spec.md`) as input to `GPU_SM-L3_ARCHITECTURE-001` (`layer_L3_architecture/specs/03_architecture_spec.md`).
