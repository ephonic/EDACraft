# ThorGpuSM — L1 behavior — Verification Test Plan

| Document ID | GPU_SM-L1_BEHAVIOR-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L1 behavior of ThorGpuSM.
...
|-------------|-------|---------|
| GPU_SM-L1_BEHAVIOR-001 | ThorGpuSM L1 behavior specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/gpu_sm/layer_L1_behavior/tests`.
...
|-------|------|------|----------|-----------|--------|
| TC-001 | test_all_warps_run | {{ tc_type_01 }} | {{ tc_prio_01 }} | Validate all warps run. | {{ tc_status_01 }} |

### 7.2 Detailed Test Cases

#### TC-001: test_all_warps_run
| Attribute | Description |
|-----------|-------------|
| Objective | Validate all warps run. |
