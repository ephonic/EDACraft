# ThorGpuSM — L1 behavior Specification

| Document ID | GPU_SM-L1_BEHAVIOR-001 |
|-------------|--------------|
| Layer       | L1 behavior |
| Module      | ThorGpuSM |
| Version     | 0.1 |
...
### 1.1 Purpose
Functional reference for one SM: 4 warps x 8 lanes, Thor ISA.

### 1.2 Scope
Cycle-unaware functional behavior of ThorGpuSM.

---

## 2. Inputs from Previous Layer

Consumes the module contract `GPU_SM-MOD-001` and the Thor-GPGPU top-level SoC requirements as the seed SpecIR.

---

## 3. Outputs to Next Layer

Emits `GPU_SM-L1_BEHAVIOR-001` (`layer_L1_behavior/specs/01_behavior_spec.md`) as input to `GPU_SM-L2_CYCLE-001` (`layer_L2_cycle/specs/02_cycle_spec.md`).
