# ThorTensorCore — L1 behavior — Verification Test Plan

| Document ID | TENSOR_CORE-L1_BEHAVIOR-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L1 behavior of ThorTensorCore.
...
|-------------|-------|---------|
| TENSOR_CORE-L1_BEHAVIOR-001 | ThorTensorCore L1 behavior specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/tensor_core/layer_L1_behavior/tests`.
...
|-------|------|------|----------|-----------|--------|
| TC-001 | test_accumulate | {{ tc_type_01 }} | {{ tc_prio_01 }} | Validate accumulate. | {{ tc_status_01 }} |

### 7.2 Detailed Test Cases

#### TC-001: test_accumulate
| Attribute | Description |
|-----------|-------------|
| Objective | Validate accumulate. |
