# ThorTensorCore — L5 dsl Test Report — Verification Test Report

| Document ID | TENSOR_CORE-L5_DSL-TR-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
| Author      | RTLCraft Agent |
| Owner       | Design Team |
| Test Plan Reference | TENSOR_CORE-L5_DSL-TP-001 |
| Status      | Draft |
...
L5 dsl tests: 5/5 passed in 2.04s.
...
thor_gpu/modules/tensor_core/layer_L5_dsl/tests/test_dsl.py .....        [100%]
