# ThorTensorCore — L4 structure — Verification Test Plan

| Document ID | TENSOR_CORE-L4_STRUCTURE-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L4 structure of ThorTensorCore.
...
|-------------|-------|---------|
| TENSOR_CORE-L4_STRUCTURE-001 | ThorTensorCore L4 structure specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/tensor_core/layer_L4_structure/tests`.
