# ThorLSU — L1 behavior Test Report — Verification Test Report

| Document ID | LSU-L1_BEHAVIOR-TR-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
| Author      | RTLCraft Agent |
| Owner       | Design Team |
| Test Plan Reference | LSU-L1_BEHAVIOR-TP-001 |
| Status      | Draft |
...
L1 behavior tests: 4/4 passed in 0.15s.
...
thor_gpu/modules/lsu/layer_L1_behavior/tests/test_behavior.py ....       [100%]
