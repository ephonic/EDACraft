# ThorLSU — L6 verilog Specification

| Document ID | LSU-L6_VERILOG-001 |
|-------------|--------------|
| Layer       | L6 verilog |
| Module      | ThorLSU |
| Version     | 0.1 |
...
### 1.1 Purpose
Verilog emission wrapper for the Thor LSU DSL contract.

### 1.2 Scope
Generated Verilog RTL and reports for ThorLSU.

---

## 2. Inputs from Previous Layer

Consumes approved outputs from `LSU-L5_DSL-001` (`layer_L5_dsl/specs/05_dsl_spec.md`) as input to `LSU-L6_VERILOG-001`.

---

## 3. Outputs to Next Layer

Emits the final RTL-generation contract `LSU-L6_VERILOG-001` (`layer_L6_verilog/specs/06_verilog_spec.md`) for module-level sign-off.
...
| Property | Value |
| --- | --- |
| File Name | thor_lsu.v |
| Dsl Class | ThorLSU |
| Key Ports | mem_req, mem_wen, rdata, done, addr |
