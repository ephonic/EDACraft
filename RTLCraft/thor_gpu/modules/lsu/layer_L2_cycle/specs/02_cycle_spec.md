# ThorLSU — L2 cycle Specification

| Document ID | LSU-L2_CYCLE-001 |
|-------------|--------------|
| Layer       | L2 cycle |
| Module      | ThorLSU |
| Version     | 0.1 |
...
### 1.1 Purpose
Cycle-level vector LSU with request/response handshake.

### 1.2 Scope
Cycle-accurate timing and protocol behavior of ThorLSU.

---

## 2. Inputs from Previous Layer

Consumes approved outputs from `LSU-L1_BEHAVIOR-001` (`layer_L1_behavior/specs/01_behavior_spec.md`) as input to `LSU-L2_CYCLE-001`.

---

## 3. Outputs to Next Layer

Emits `LSU-L2_CYCLE-001` (`layer_L2_cycle/specs/02_cycle_spec.md`) as input to `LSU-L3_ARCHITECTURE-001` (`layer_L3_architecture/specs/03_architecture_spec.md`).
...
| --- | --- |
| Latency Cycles | 1 |
| Pipeline Stages | request, response |
