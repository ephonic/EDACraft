# ThorSharedMemory — L6 verilog — Verification Test Plan

| Document ID | SHARED_MEMORY-L6_VERILOG-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L6 verilog of ThorSharedMemory.
...
|-------------|-------|---------|
| SHARED_MEMORY-L6_VERILOG-001 | ThorSharedMemory L6 verilog specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/shared_memory/layer_L6_verilog/tests`.
