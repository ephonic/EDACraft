# ThorSharedMemory — L1 behavior Specification

| Document ID | SHARED_MEMORY-L1_BEHAVIOR-001 |
|-------------|--------------|
| Layer       | L1 behavior |
...
### 1.1 Purpose
Per-SM shared SRAM functional model (256-bit word, 4096 deep).

### 1.2 Scope
Cycle-unaware functional behavior of ThorSharedMemory.

---

## 2. Inputs from Previous Layer

Consumes the module contract `SHARED_MEMORY-MOD-001` and the Thor-GPGPU top-level SoC requirements as the seed SpecIR.

---

## 3. Outputs to Next Layer

Emits `SHARED_MEMORY-L1_BEHAVIOR-001` (`layer_L1_behavior/specs/01_behavior_spec.md`) as input to `SHARED_MEMORY-L2_CYCLE-001` (`layer_L2_cycle/specs/02_cycle_spec.md`).
