# ThorSharedMemory — L1 behavior — Verification Test Plan

| Document ID | SHARED_MEMORY-L1_BEHAVIOR-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L1 behavior of ThorSharedMemory.
...
|-------------|-------|---------|
| SHARED_MEMORY-L1_BEHAVIOR-001 | ThorSharedMemory L1 behavior specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/shared_memory/layer_L1_behavior/tests`.
...
|-------|------|------|----------|-----------|--------|
| TC-001 | test_address_mask | {{ tc_type_01 }} | {{ tc_prio_01 }} | Validate address mask. | {{ tc_status_01 }} |

### 7.2 Detailed Test Cases

#### TC-001: test_address_mask
| Attribute | Description |
|-----------|-------------|
| Objective | Validate address mask. |
