# ThorSharedMemory — L4 structure — Verification Test Plan

| Document ID | SHARED_MEMORY-L4_STRUCTURE-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L4 structure of ThorSharedMemory.
...
|-------------|-------|---------|
| SHARED_MEMORY-L4_STRUCTURE-001 | ThorSharedMemory L4 structure specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/shared_memory/layer_L4_structure/tests`.
