# ThorSharedMemory — Module Design Specification

| Document ID | SHARED_MEMORY-MOD-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
| Author      | RTLCraft Agent |
| Owner       | Design Team |
| Module ID   | SHARED_MEMORY |
| Status      | Draft |
...
### 1.1 Purpose
Per-SM single-port shared SRAM (256-bit word, 4096 deep, registered read).
