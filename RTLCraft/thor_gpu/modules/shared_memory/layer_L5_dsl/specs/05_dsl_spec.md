# ThorSharedMemory — L5 dsl Specification

| Document ID | SHARED_MEMORY-L5_DSL-001 |
|-------------|--------------|
| Layer       | L5 dsl |
...
### 1.1 Purpose
RTL-ready per-SM shared SRAM (4096x256b, registered read).

### 1.2 Scope
RTL-ready DSL description of ThorSharedMemory.

---

## 2. Inputs from Previous Layer

Consumes approved outputs from `SHARED_MEMORY-L4_STRUCTURE-001` (`layer_L4_structure/specs/04_structural_spec.md`) as input to `SHARED_MEMORY-L5_DSL-001`.

---

## 3. Outputs to Next Layer

Emits `SHARED_MEMORY-L5_DSL-001` (`layer_L5_dsl/specs/05_dsl_spec.md`) as input to `SHARED_MEMORY-L6_VERILOG-001` (`layer_L6_verilog/specs/06_verilog_spec.md`).
...
`addr[12], wdata[256], we, re -> rdata[256]`
