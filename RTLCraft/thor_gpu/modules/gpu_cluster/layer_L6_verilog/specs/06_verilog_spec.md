# ThorCluster — L6 verilog Specification

| Document ID | GPU_CLUSTER-L6_VERILOG-001 |
|-------------|--------------|
| Layer       | L6 verilog |
| Module      | ThorCluster |
| Version     | 0.1 |
...
### 1.1 Purpose
Verilog emission wrapper for the Thor cluster top DSL contract.

### 1.2 Scope
Generated Verilog RTL and reports for ThorCluster.

---

## 2. Inputs from Previous Layer

Consumes approved outputs from `GPU_CLUSTER-L5_DSL-001` (`layer_L5_dsl/specs/05_dsl_spec.md`) as input to `GPU_CLUSTER-L6_VERILOG-001`.

---

## 3. Outputs to Next Layer

Emits the final RTL-generation contract `GPU_CLUSTER-L6_VERILOG-001` (`layer_L6_verilog/specs/06_verilog_spec.md`) for module-level sign-off.
...
| Property | Value |
| --- | --- |
| File Name | thor_cluster.v |
| Dsl Class | ThorCluster |
| Key Ports | all_done, sm0_w0_acc0, sm1_w0_acc0, start, mem_req |
