# ThorCluster — Module Design Specification

| Document ID | GPU_CLUSTER-MOD-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
| Author      | RTLCraft Agent |
| Owner       | Design Team |
| Module ID   | GPU_CLUSTER |
| Status      | Draft |
...
### 1.1 Purpose
2-SM compute cluster with a round-robin L2 arbiter over global memory (cluster top).
