# ThorCluster — L3 architecture — Verification Test Plan

| Document ID | GPU_CLUSTER-L3_ARCHITECTURE-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L3 architecture of ThorCluster.
...
|-------------|-------|---------|
| GPU_CLUSTER-L3_ARCHITECTURE-001 | ThorCluster L3 architecture specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/gpu_cluster/layer_L3_architecture/tests`.
