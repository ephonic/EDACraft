# ThorCluster — L1 behavior Specification

| Document ID | GPU_CLUSTER-L1_BEHAVIOR-001 |
|-------------|--------------|
| Layer       | L1 behavior |
| Module      | ThorCluster |
| Version     | 0.1 |
...
### 1.1 Purpose
2-SM compute cluster with round-robin L2 arbiter (functional reference).

### 1.2 Scope
Cycle-unaware functional behavior of ThorCluster.

---

## 2. Inputs from Previous Layer

Consumes the module contract `GPU_CLUSTER-MOD-001` and the Thor-GPGPU top-level SoC requirements as the seed SpecIR.

---

## 3. Outputs to Next Layer

Emits `GPU_CLUSTER-L1_BEHAVIOR-001` (`layer_L1_behavior/specs/01_behavior_spec.md`) as input to `GPU_CLUSTER-L2_CYCLE-001` (`layer_L2_cycle/specs/02_cycle_spec.md`).
