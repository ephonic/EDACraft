# ThorCluster — L1 behavior — Verification Test Plan

| Document ID | GPU_CLUSTER-L1_BEHAVIOR-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L1 behavior of ThorCluster.
...
|-------------|-------|---------|
| GPU_CLUSTER-L1_BEHAVIOR-001 | ThorCluster L1 behavior specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/gpu_cluster/layer_L1_behavior/tests`.
...
|-------|------|------|----------|-----------|--------|
| TC-001 | test_both_sms_complete | {{ tc_type_01 }} | {{ tc_prio_01 }} | Validate both sms complete. | {{ tc_status_01 }} |

### 7.2 Detailed Test Cases

#### TC-001: test_both_sms_complete
| Attribute | Description |
|-----------|-------------|
| Objective | Validate both sms complete. |
