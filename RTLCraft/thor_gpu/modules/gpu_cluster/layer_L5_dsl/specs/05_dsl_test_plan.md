# ThorCluster — L5 dsl — Verification Test Plan

| Document ID | GPU_CLUSTER-L5_DSL-TP-001 |
|-------------|--------------|
| Version     | 0.1 |
| Date        | 2026-06-17 |
...
### 1.1 Purpose
Verification test plan for the L5 dsl of ThorCluster.
...
|-------------|-------|---------|
| GPU_CLUSTER-L5_DSL-001 | ThorCluster L5 dsl specification | 0.1 |
...
Run the pytest cases under `thor_gpu/modules/gpu_cluster/layer_L5_dsl/tests`.
