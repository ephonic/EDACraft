"""Run a larger rtlgen simulator stress sweep and save the report."""
...
from rtlgen.sim import run_stress_sweep, write_stress_sweep_report
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run a stress sweep across rtlgen compiled simulator benchmarks.")
