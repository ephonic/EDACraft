...
#define SVN "1006:1044" /* svn release version */
#include <stdlib.h>
...
#define ALIAS\
  AALIAS(variable,static,math,static)\
AALIAS(variable,dynamic,math,dynamic)\
AALIAS(expression,static,math,static)\
AALIAS(expression,dynamic,math,dynamic)\
AALIAS(nilled,static,math,static)\
AALIAS(nilled,dynamic,math,dynamic)\
AALIAS(assignment,static,math,static)\
AALIAS(assignment,dynamic,math,dynamic)\
AALIAS(contribution,static,math,static)\
AALIAS(contribution,dynamic,math,dynamic)\
AALIAS(conditional,static,math,static)\
AALIAS(conditional,dynamic,math,dynamic)\
AALIAS(forloop,static,math,static)\
AALIAS(forloop,dynamic,math,dynamic)\
AALIAS(whileloop,static,math,static)\
AALIAS(whileloop,dynamic,math,dynamic)\
AALIAS(case,static,math,static)\
AALIAS(case,dynamic,math,dynamic)\
AALIAS(blockvariable,static,math,static)\
AALIAS(blockvariable,dynamic,math,dynamic)\
AALIAS(block,static,math,static)\
AALIAS(block,dynamic,math,dynamic)\
AALIAS(callfunction,static,math,static)\
AALIAS(callfunction,dynamic,math,dynamic)\
/*fin*/
...
EEA(variable,lexval)\
EEA(variable,block)\
EEA(variable,parametertype)\
EEA(variable,type)\
EEA(variable,sizetype)\
EEA(variable,maxsize)\
EEA(variable,minsize)\
EEA(variable,input)\
EEA(variable,output)\
EEA(variable,scope)\
EEA(variable,default)\
EEA(variable,derivate)\
EEA(variable,isstate)\
EEA(variable,usedinmodel)\
EEA(variable,usedininstance)\
EEA(variable,usedininitial_step)\
EEA(variable,usedinevaluate)\
EEA(variable,usedinnoise)\
EEA(variable,usedinfinal)\
EEA(variable,setinmodel)\
EEA(variable,setininstance)\
EEA(variable,setininitial_step)\
EEA(variable,setinevaluate)\
EEA(variable,setinnoise)\
EEA(variable,setinfinal)\
EEA(variable,setingetprev)\
EEA(variable,TemperatureDependent)\
EEA(variable,OPdependent)\
EEA(variable,insource)\
EEA(variable,vcount)\
EEA(variable,vlast)\
EEA(variable,alias)\
EEA(variable,range)\
EEA(variable,attribute)\
EEA(variable,assignment)\
EEA(variable,probe)\
EEA(variable,ddxprobe)\
EEA(variable,variable)\
EEA(array,variable)\
EEA(array,index)\
EEA(probe,module)\
EEA(probe,branch)\
...
#define EAVA\
  EEAVA(simulator,name)\
EEAVA(simulator,currentdate)\
EEAVA(simulator,developer)\
EEAVA(simulator,fullname)\
EEAVA(simulator,package_name)\
EEAVA(simulator,package_tarname)\
EEAVA(simulator,package_version)\
EEAVA(simulator,package_string)\
EEAVA(simulator,package_bugreport)\
EEAVA(simulator,probe)\
EEAVA(simulator,tmp)\
EEAVA(simulator,tmp1)\
EEAVA(simulator,br1)\
EEAVA(simulator,br2)\
EEAVA(simulator,sr1)\
EEAVA(simulator,ddx)\
EEAVA(admsmain,name)\
EEAVA(admsmain,argc)\
EEAVA(admsmain,filename)\
EEAVA(admsmain,curfilename)\
EEAVA(admsmain,curline)\
EEAVA(admsmain,fpos)\
EEAVA(admsmain,simulator)\
EEAVA(admsmain,info)\
EEAVA(admsmain,usage)\
EEAVA(admsmain,verbose)\
EEAVA(admsmain,hint)\
EEAVA(admsmain,warning)\
EEAVA(admsmain,obsolete)\
EEAVA(admsmain,debug)\
EEAVA(admsmain,dbg_vla)\
EEAVA(admsmain,dbg_xml)\
EEAVA(admsmain,error)\
EEAVA(admsmain,fatal)\
EEAVA(admsmain,dbg_mem)\
EEAVA(admsmain,module)\
EEAVA(admsmain,discipline)\
EEAVA(admsmain,nature)\
EEAVA(admsmain,variable)\
EEAVA(admsmain,argv)\
EEAVA(admsmain,transform)\
EEAVA(admsmain,invtransform)\
EEAVA(admsmain,itransform)\
EEAVA(admsmain,itransforminsideapplytemplate)\
EEAVA(admsmain,valueof)\
EEAVA(list,datatype)\
EEAVA(list,item)\
EEAVA(nature,access)\
EEAVA(nature,name)\
EEAVA(nature,abstol)\
EEAVA(nature,base)\
EEAVA(nature,ddt_name)\
EEAVA(nature,ddt_nature)\
EEAVA(nature,idt_name)\
EEAVA(nature,idt_nature)\
EEAVA(nature,units)\
EEAVA(discipline,name)\
EEAVA(discipline,flow)\
EEAVA(discipline,potential)\
EEAVA(discipline,domain)\
EEAVA(module,name)\
EEAVA(module,evaluation)\
EEAVA(module,analog)\
EEAVA(module,node)\
EEAVA(module,block)\
EEAVA(module,contribution)\
EEAVA(module,assignment)\
EEAVA(module,expression)\
EEAVA(module,conditional)\
EEAVA(module,blockvariable)\
EEAVA(module,branch)\
EEAVA(module,jacobian)\
EEAVA(module,probe)\
EEAVA(module,source)\
EEAVA(module,instance)\
EEAVA(module,instantiator)\
EEAVA(module,branchalias)\
EEAVA(module,range)\
EEAVA(module,nodealias)\
EEAVA(module,variable)\
EEAVA(module,analogfunction)\
EEAVA(module,attribute)\
EEAVA(analogfunction,module)\
EEAVA(analogfunction,lexval)\
EEAVA(analogfunction,type)\
EEAVA(analogfunction,tree)\
EEAVA(analogfunction,variable)\
EEAVA(analogfunction,attribute)\
EEAVA(nodealias,module)\
EEAVA(nodealias,name)\
EEAVA(nodealias,node)\
EEAVA(node,module)\
EEAVA(node,name)\
EEAVA(node,direction)\
EEAVA(node,discipline)\
EEAVA(node,grounded)\
EEAVA(node,location)\
EEAVA(node,attribute)\
EEAVA(branchalias,module)\
EEAVA(branchalias,name)\
EEAVA(branchalias,branch)\
EEAVA(branch,module)\
EEAVA(branch,pnode)\
EEAVA(branch,nnode)\
EEAVA(branch,discipline)\
EEAVA(branch,grounded)\
EEAVA(branch,attribute)\
EEAVA(source,module)\
EEAVA(source,branch)\
EEAVA(source,nature)\
EEAVA(source,discipline)\
EEAVA(source,static)\
EEAVA(source,dynamic)\
EEAVA(source,whitenoise)\
EEAVA(source,flickernoise)\
EEAVA(source,grounded)\
EEAVA(source,switch)\
EEAVA(source,type)\
EEAVA(source,probe)\
EEAVA(source,attribute)\
EEAVA(range,module)\
EEAVA(range,infexpr)\
EEAVA(range,supexpr)\
EEAVA(range,name)\
EEAVA(range,infboundtype)\
EEAVA(range,supboundtype)\
EEAVA(range,type)\
EEAVA(jacobian,module)\
EEAVA(jacobian,row)\
EEAVA(jacobian,column)\
EEAVA(jacobian,diagonal)\
EEAVA(jacobian,static)\
EEAVA(jacobian,dynamic)\
EEAVA(analog,code)\
EEAVA(math,name)\
EEAVA(math,value)\
EEAVA(math,static)\
EEAVA(math,dynamic)\
EEAVA(math,dependency)\
EEAVA(math,attribute)\
EEAVA(string,value)\
EEAVA(subexpression,expression)\
EEAVA(mapply_unary,name)\
EEAVA(mapply_unary,arg1)\
EEAVA(mapply_binary,name)\
EEAVA(mapply_binary,arg1)\
EEAVA(mapply_binary,arg2)\
EEAVA(mapply_ternary,name)\
EEAVA(mapply_ternary,arg1)\
EEAVA(mapply_ternary,arg2)\
EEAVA(mapply_ternary,arg3)\
EEAVA(number,value)\
EEAVA(number,scalingunit)\
EEAVA(function,name)\
EEAVA(function,unique_id)\
EEAVA(function,definition)\
EEAVA(function,class)\
EEAVA(function,arguments)\
EEAVA(variable,module)\
EEAVA(variable,lexval)\
EEAVA(variable,block)\
EEAVA(variable,parametertype)\
EEAVA(variable,type)\
EEAVA(variable,sizetype)\
EEAVA(variable,maxsize)\
EEAVA(variable,minsize)\
EEAVA(variable,input)\
EEAVA(variable,output)\
EEAVA(variable,scope)\
EEAVA(variable,default)\
EEAVA(variable,derivate)\
EEAVA(variable,isstate)\
EEAVA(variable,usedinmodel)\
EEAVA(variable,usedininstance)\
EEAVA(variable,usedininitial_step)\
EEAVA(variable,usedinevaluate)\
EEAVA(variable,usedinnoise)\
EEAVA(variable,usedinfinal)\
EEAVA(variable,setinmodel)\
EEAVA(variable,setininstance)\
EEAVA(variable,setininitial_step)\
EEAVA(variable,setinevaluate)\
EEAVA(variable,setinnoise)\
EEAVA(variable,setinfinal)\
EEAVA(variable,setingetprev)\
EEAVA(variable,TemperatureDependent)\
EEAVA(variable,OPdependent)\
EEAVA(variable,insource)\
EEAVA(variable,vcount)\
EEAVA(variable,vlast)\
EEAVA(variable,alias)\
EEAVA(variable,range)\
EEAVA(variable,attribute)\
EEAVA(variable,assignment)\
EEAVA(variable,probe)\
EEAVA(variable,ddxprobe)\
EEAVA(variable,variable)\
EEAVA(array,variable)\
EEAVA(array,index)\
EEAVA(probe,module)\
EEAVA(probe,branch)\
EEAVA(probe,nature)\
EEAVA(probe,seen)\
EEAVA(probe,discipline)\
EEAVA(probe,grounded)\
EEAVA(probe,source)\
EEAVA(expression,module)\
EEAVA(expression,tree)\
EEAVA(expression,hasspecialnumber)\
EEAVA(expression,hasVoltageDependentFunction)\
EEAVA(expression,TemperatureDependent)\
EEAVA(expression,value)\
EEAVA(expression,function)\
EEAVA(expression,probe)\
EEAVA(expression,variable)\
EEAVA(instance,instantiator)\
EEAVA(instance,module)\
EEAVA(instance,name)\
EEAVA(instance,terminal)\
EEAVA(instance,parameterset)\
EEAVA(instanceparameter,parameter)\
EEAVA(instanceparameter,value)\
EEAVA(instancenode,nodefrominstantiator)\
EEAVA(instancenode,nodefrommodule)\
EEAVA(nilled,module)\
EEAVA(nilled,name)\
EEAVA(assignment,module)\
EEAVA(assignment,lhs)\
EEAVA(assignment,rhs)\
EEAVA(assignment,lexval)\
EEAVA(assignment,name)\
EEAVA(assignment,attribute)\
EEAVA(contribution,module)\
EEAVA(contribution,lhs)\
EEAVA(contribution,rhs)\
EEAVA(contribution,lexval)\
EEAVA(contribution,branchalias)\
EEAVA(contribution,name)\
EEAVA(contribution,whitenoise)\
EEAVA(contribution,flickernoise)\
EEAVA(contribution,attribute)\
EEAVA(conditional,module)\
EEAVA(conditional,if)\
EEAVA(conditional,then)\
EEAVA(conditional,else)\
EEAVA(conditional,name)\
EEAVA(forloop,module)\
EEAVA(forloop,initial)\
EEAVA(forloop,condition)\
EEAVA(forloop,update)\
EEAVA(forloop,forblock)\
EEAVA(forloop,name)\
EEAVA(whileloop,module)\
EEAVA(whileloop,while)\
EEAVA(whileloop,whileblock)\
EEAVA(whileloop,name)\
EEAVA(case,module)\
EEAVA(case,case)\
EEAVA(case,name)\
EEAVA(case,caseitem)\
EEAVA(caseitem,code)\
EEAVA(caseitem,defaultcase)\
EEAVA(caseitem,condition)\
EEAVA(blockvariable,block)\
EEAVA(blockvariable,variable)\
EEAVA(block,module)\
EEAVA(block,lexval)\
EEAVA(block,block)\
EEAVA(block,item)\
EEAVA(block,attribute)\
EEAVA(block,variable)\
EEAVA(block,probe)\
EEAVA(callfunction,module)\
EEAVA(callfunction,function)\
EEAVA(evaluation,variable)\
EEAVA(attribute,name)\
EEAVA(attribute,value)\
EEAVA(lexval,string)\
EEAVA(lexval,f)\
EEAVA(lexval,l)\
EEAVA(lexval,c)\
...
win32_interface int admstpathparse ();
win32_interface void postpath (p_path mypath);
win32_interface void dbpath (p_path mypath);
win32_interface void dbtext (p_text mytext);
...
typedef void (*_p_cbcondition) (p_path mypath,p_admst myadmst);
win32_interface void free_ptraverse (p_ptraverse p);
win32_interface int retposition (p_admst myadmst,int offset);
win32_interface p_ptraverse ptraverse (p_admst dot,p_path mypath0);
...
win32_interface void adms_module_list_variable_prepend_once_or_abort (p_module mymymodule,p_variable myvariable);
win32_interface p_variable adms_module_list_variable_lookup_by_id (p_module mymymodule,p_module mymodule,p_lexval mylexval,p_adms myblock);
...
win32_interface void adms_analogfunction_list_variable_prepend_once_or_abort (p_analogfunction mymyanalogfunction,p_variable myvariable);
win32_interface p_variable adms_analogfunction_list_variable_lookup_by_id (p_analogfunction mymyanalogfunction,p_module mymodule,p_lexval mylexval,p_adms myblock);
...
win32_interface void adms_range_valueto_infboundtype (p_range myrange,const char* _infboundtype);
win32_interface void adms_range_valueto_supboundtype (p_range myrange,const char* _supboundtype);
...
win32_interface p_number adms_number_new(const char* myvalue);
win32_interface void adms_number_free(p_number mynumber);
win32_interface void adms_number_valueto_value (p_number mynumber,const char* _value);
...
win32_interface p_function adms_function_new(const char* myname,int myunique_id);
win32_interface void adms_function_free(p_function myfunction);
win32_interface void adms_function_valueto_name (p_function myfunction,const char* _name);
...
win32_interface p_variable adms_variable_new(p_module mymodule,p_lexval mylexval,p_adms myblock);
win32_interface void adms_variable_free(p_variable myvariable);
win32_interface void adms_variable_valueto_module (p_variable myvariable,p_module _module);
win32_interface void adms_variable_valueto_lexval (p_variable myvariable,p_lexval _lexval);
win32_interface void adms_variable_valueto_block (p_variable myvariable,p_adms _block);
win32_interface void adms_variable_valueto_parametertype (p_variable myvariable,admse _parametertype);
win32_interface void adms_variable_valueto_type (p_variable myvariable,admse _type);
win32_interface void adms_variable_valueto_sizetype (p_variable myvariable,admse _sizetype);
win32_interface void adms_variable_valueto_maxsize (p_variable myvariable,p_number _maxsize);
win32_interface void adms_variable_valueto_minsize (p_variable myvariable,p_number _minsize);
win32_interface void adms_variable_valueto_input (p_variable myvariable,admse _input);
win32_interface void adms_variable_valueto_output (p_variable myvariable,admse _output);
win32_interface void adms_variable_valueto_scope (p_variable myvariable,admse _scope);
win32_interface void adms_variable_valueto_default (p_variable myvariable,p_expression _default);
win32_interface void adms_variable_valueto_derivate (p_variable myvariable,admse _derivate);
win32_interface void adms_variable_valueto_isstate (p_variable myvariable,admse _isstate);
win32_interface void adms_variable_valueto_usedinmodel (p_variable myvariable,admse _usedinmodel);
win32_interface void adms_variable_valueto_usedininstance (p_variable myvariable,admse _usedininstance);
win32_interface void adms_variable_valueto_usedininitial_step (p_variable myvariable,admse _usedininitial_step);
win32_interface void adms_variable_valueto_usedinevaluate (p_variable myvariable,admse _usedinevaluate);
win32_interface void adms_variable_valueto_usedinnoise (p_variable myvariable,admse _usedinnoise);
win32_interface void adms_variable_valueto_usedinfinal (p_variable myvariable,admse _usedinfinal);
win32_interface void adms_variable_valueto_setinmodel (p_variable myvariable,admse _setinmodel);
win32_interface void adms_variable_valueto_setininstance (p_variable myvariable,admse _setininstance);
win32_interface void adms_variable_valueto_setininitial_step (p_variable myvariable,admse _setininitial_step);
win32_interface void adms_variable_valueto_setinevaluate (p_variable myvariable,admse _setinevaluate);
win32_interface void adms_variable_valueto_setinnoise (p_variable myvariable,admse _setinnoise);
win32_interface void adms_variable_valueto_setinfinal (p_variable myvariable,admse _setinfinal);
win32_interface void adms_variable_valueto_setingetprev (p_variable myvariable,admse _setingetprev);
win32_interface void adms_variable_valueto_TemperatureDependent (p_variable myvariable,admse _TemperatureDependent);
win32_interface void adms_variable_valueto_OPdependent (p_variable myvariable,admse _OPdependent);
win32_interface void adms_variable_valueto_insource (p_variable myvariable,admse _insource);
win32_interface void adms_variable_valueto_vcount (p_variable myvariable,int _vcount);
win32_interface void adms_variable_valueto_vlast (p_variable myvariable,p_assignment _vlast);
win32_interface void adms_variable_valueto_alias (p_variable myvariable,p_slist _alias);
win32_interface void adms_variable_list_alias_prepend_once_or_abort (p_variable mymyvariable,const char* myalias);
win32_interface void adms_variable_valueto_range (p_variable myvariable,p_slist _range);
win32_interface void adms_variable_valueto_attribute (p_variable myvariable,p_slist _attribute);
win32_interface void adms_variable_valueto_assignment (p_variable myvariable,p_slist _assignment);
win32_interface void adms_variable_valueto_probe (p_variable myvariable,p_slist _probe);
win32_interface void adms_variable_valueto_ddxprobe (p_variable myvariable,p_slist _ddxprobe);
win32_interface void adms_variable_valueto_variable (p_variable myvariable,p_slist _variable);
...
struct s_instanceparameter {
  t_math _math;
  p_variable _parameter;
  int _parameter_isdefault : 2;
  p_expression _value;
  int _value_isdefault : 2;
};
win32_interface char*adms_instanceparameter_uid (p_instanceparameter myinstanceparameter);
win32_interface p_instanceparameter adms_instanceparameter_new(p_variable myparameter);
win32_interface void adms_instanceparameter_free(p_instanceparameter myinstanceparameter);
win32_interface void adms_instanceparameter_valueto_parameter (p_instanceparameter myinstanceparameter,p_variable _parameter);
...
win32_interface void adms_block_list_variable_prepend_once_or_abort (p_block mymyblock,p_variable myvariable);
...
win32_interface void adms_text_valueto_toptype (p_text mytext,int _toptype);
...
win32_interface void adms_path_valueto_id (p_path mypath,const char* _id);
win32_interface void adms_path_valueto_data (p_path mypath,p_adms _data);
...
win32_interface void adms_path_valueto_condition (p_path mypath,p_slist _condition);
win32_interface void adms_path_valueto_l (p_path mypath,p_slist _l);
win32_interface void adms_path_valueto_r (p_path mypath,p_slist _r);
...
win32_interface p_ptraverse adms_ptraverse_new(p_path mypath);
win32_interface void adms_ptraverse_free(p_ptraverse myptraverse);
win32_interface void adms_ptraverse_valueto_path (p_ptraverse myptraverse,p_path _path);
...
win32_interface p_admst adms_admst_new(p_admst myprevious);
...
win32_interface void adms_admst_valueto_ptraverse (p_admst myadmst,p_ptraverse _ptraverse);
...
win32_interface void adms_admst_valueto_pseudo (p_admst myadmst,int _pseudo);
win32_interface void adms_admst_valueto_hasnewbasicstring (p_admst myadmst,int _hasnewbasicstring);
win32_interface void adms_admst_valueto_ori (p_admst myadmst,p_admst _ori);
win32_interface void adms_admst_valueto_refd (p_admst myadmst,int _refd);
win32_interface void adms_admst_valueto_istrue (p_admst myadmst,admse _istrue);
...
win32_interface void adms_transform_valueto_textvalue (p_transform mytransform,p_text _textvalue);
