...
`else
  ...
  // charge of electron in coulombs (HSPICE/FineSim aligned)
  `define P_Q 1.60219e-19
  // speed of light in vacuum in meters/sec
  `define P_C 2.99792458e8
  // Boltzmann's constant in joules/kelvin (KboQ = P_K/P_Q = 8.617087e-5)
  `define P_K 1.38062e-23
  // Planck�s constant in joules*sec
  `define P_H 6.62606876e-34
  // permittivity of vacuum in farads/meter
  `define P_EPS0 8.8542e-12
