...
//
//        "typedef ... complex" has been renamed to complex to
...
// Apr 12 2005 yami
// I have changed f2c_real to real and f2c_complex to complex, since
// C++'s namespace mechanic can prevent name conflictions.
...
/* abs is commented by lapack++ min max is commented by yami.  MACRO
 * is too dangerous, it conflicts with numeric_limits<>::min()/max().
 */
...
#endif  //end HSIS_F2c_H


/* yami: I comment out the following, otherwise there are conficts with
C++ math.h. I think we have fortran lib already so it's useless.
 */
