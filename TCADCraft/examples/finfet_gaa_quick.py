#!/usr/bin/env python3
"""
FinFET and GAA Device Simulation - Optimized Version

This script performs fast simulations with coarser grids for quick visualization.
"""
...
def simulate_finfet_fast():
    """Fast FinFET simulation with coarser grid"""
    print("=" * 60)
    print("FinFET Fast Simulation")
    print("=" * 60)
    ...
    # Coarser mesh for faster simulation
...
def simulate_gaa_fast():
    """Fast GAA simulation with coarser grid"""
    print("\n" + "=" * 60)
    print("GAA Nanosheet Fast Simulation")
    print("=" * 60)
...
def plot_3d_structure(mesh, results, device_name, filename):
    """Plot 3D structure with electron density and potential"""
...
def main():
    ...
    print("\n" + "=" * 70)
    print("FinFET and GAA Device Simulation - Fast Version")
    print("=" * 70 + "\n")
    
    # Simulate FinFET
    finfet_mesh, finfet_results, finfet_device = simulate_finfet_fast()
    
    # Simulate GAA
    gaa_mesh, gaa_results, gaa_device = simulate_gaa_fast()
    
    # Create 3D structure plots
    plot_3d_structure(finfet_mesh, finfet_results, 'FinFET', 'finfet_3d_fast.png')
    plot_3d_structure(gaa_mesh, gaa_results, 'GAA Nanosheet', 'gaa_3d_fast.png')
    
    # Create mesh discretization plots
    plot_mesh_discretization(finfet_mesh, gaa_mesh)
    
    # Create 2D slice plots
    plot_2d_slices(finfet_mesh, finfet_results, 'FinFET', 'finfet_2d_fast.png')
    plot_2d_slices(gaa_mesh, gaa_results, 'GAA Nanosheet', 'gaa_2d_fast.png')
    
    print("\n" + "=" * 70)
    print("Simulation Complete!")
    print("=" * 70)
    print("\nGenerated files:")
    print("  - finfet_3d_fast.png")
    print("  - gaa_3d_fast.png")
    print("  - mesh_discretization.png")
    print("  - finfet_2d_fast.png")
    print("  - gaa_2d_fast.png")
