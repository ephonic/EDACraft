...
set var(ref_clock)      {ref_virtual_ck 3.2}
...
########################################################################################
######	(IMPORTANT! The lowest 'topmetal' for T16FFP* should be 'M6', not 'M5' or below!.)
########################################################################################

set clock(clk)			{4  0.500 0.150 0.100 M7  CTS}
#set clock(MESH_CLOCK)			{0.625 0.083 0.165 0.100 M6 MESH}
#set clock(MESH_CLOCK_WITH_REGION)	{0.625 0.083 0.165 0.100 M6 MESH {100 100 200 200}}
