...
set var(ref_clock)      {ref_ck 0.400}
...
#set clock(CTS_CLOCK)			{0.400 0.083 0.165 0.100 M5 CTS}
#set clock(MESH_CLOCK)			{0.400 0.083 0.165 0.100 M5 MESH}
#set clock(MESH_CLOCK_WITH_REGION)	{0.400 0.083 0.165 0.100 M5 MESH {100 100 200 200}}
