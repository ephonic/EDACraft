...
create_mode func
create_corner wc
create_scenario -name func.ss0p9v.wc.cmax_85c.setup -mode func -corner wc
current_scenario func.ss0p9v.wc.cmax_85c.setup
source -e /share/home/limuhan/Projects/BP_TapeOut_WorkSpace/BP_TapeOut_syn/work/DC/out_0/Compute_unit.sdc
...
set_scenario_status func.ss0p9v.wc.cmax_85c.setup -none
set_scenario_status func.ss0p9v.wc.cmax_85c.setup -setup true -max_transition true -max_capacitance true
set_temperature -corners wc 85
...
####### func hold
create_corner bc
create_scenario -name func.ff1p1v.bc.cmin_85c.hold -mode func -corner bc
current_scenario func.ff1p1v.bc.cmin_85c.hold
source -e /share/home/limuhan/Projects/BP_TapeOut_WorkSpace/BP_TapeOut_syn/work/DC/out_0/Compute_unit.sdc
...
set_scenario_status func.ff1p1v.bc.cmin_85c.hold -none
set_scenario_status func.ff1p1v.bc.cmin_85c.hold -hold true -max_transition true -max_capacitance true
set_temperature -corners bc 85 -min 85
if {![sizeof [get_nets -q VDD]]} {create_net -power VDD}
set_voltage 0.9 -min 0.9 -corners wc -object_list [get_supply_nets VDD]
if {![sizeof [get_nets -q VSS]]} {create_net -ground VSS}
set_voltage 0.0 -min 0.0 -corners wc -object_list [get_supply_nets VSS]
